...
.input-group .input-buttons {
    ...
    var confirmIt = function (e) {
        if (!confirm('Are you sure you want to create a new dealsheet?')) e.preventDefault();
    };
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="forename" class="form-control input-md" placeholder="Forename" value="<?php if(isset($data2['forename'])) { echo $data2['forename'];} ?>">
                                </div>
                                
                                <div class="col-md-6">
                                    <label class="col-md-6 control-label" for="textinput">Forename (2)</label>
                                    <input type="text" name="forename2" class="form-control input-md" placeholder="Forename" value="<?php if(isset($data2['forename2'])) { echo $data2['forename2'];} ?>">
                                </div> 
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="surname" class="form-control input-md" placeholder="Surname" value="<?php if(isset($data2['surname'])) { echo $data2['surname'];} ?>">
                                </div>
                                
                                <div class="col-md-6">
                                    <label class="col-md-6 control-label" for="surname2">Surname (2)</label>
                                    <input type="text" name="surname2" class="form-control input-md" placeholder="Surname" value="<?php if(isset($data2['surname2'])) { echo $data2['surname2'];} ?>">
                                </div>
  ...
  ++$INCyear;
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="postcode" class="form-control input-md" placeholder="Post Code" value="<?php if(isset($data2['postcode'])) { echo $data2['postcode'];} ?>">
                                    </div>
                                    
                                    <div class="col-md-3">
                                        <label class="col-md-4 control-label" for="textinput">Mobile</label>
                                        <input type="text" name="mobile" class="form-control input-md" placeholder="Mobile No" required pattern=".{11}|.{11,12}" maxlength="12" title="Enter a valid phone number" value="<?php if(isset($data2['mobile'])) { echo $data2['mobile'];} ?>">
                                    </div>
                                    
                                    <div class="col-md-3">
                                        <label class="col-md-4 control-label" for="textinput">Home</label>
                                        <input type="text" name="home" class="form-control input-md" placeholder="Home No" pattern=".{11}|.{11,12}" maxlength="12" title="Enter a valid phone number" value="<?php if(isset($data2['home'])) { echo $data2['home'];} ?>">
                                    </div>
                                    
                                    <div class="col-md-3">
                                        <label class="col-md-4 control-label" for="textinput">Email</label>
                                        <input type="text" name="email" class="form-control input-md" placeholder="Email" value="<?php if(isset($data2['email'])) { echo $data2['email'];} ?>">
                                    </div>
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="q1a" class="form-control input-md" value="<?php if(isset($data3['q1a'])) { echo $data3['q1a'];} ?>">
                        </div>
                        
                        <div class="col-md-2">
                            <label class="col-md-2 control-label" for="q1b" style="color:blue;">Mortgage</label>
                            <input type="text" name="q1b" class="form-control input-md" placeholder="£" value="<?php if(isset($data3['q1b'])) { echo $data3['q1b'];} ?>">
                        </div>
                        
                        <div class="col-md-2">
                            <label class="col-md-2 control-label" for="q1c" style="color:blue;">Years</label>
                            <input type="text" name="q1c" class="form-control input-md" placeholder="5 years" value="<?php if(isset($data3['q1c'])) { echo $data3['q1c'];} ?>">
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="q2a" class="form-control input-md" value="<?php if(isset($data3['q2a'])) { echo $data3['q2a'];} ?>">
                        </div>  
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="q3a" class="form-control input-md" placeholder="Broker, Financial Advisor, etc..." value="<?php if(isset($data3['q3a'])) { echo $data3['q3a'];} ?>">
                        </div> 
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="q4a" class="form-control input-md" placeholder="Married, divored, children, moved home, etc..." value="<?php if(isset($data3['q4a'])) { echo $data3['q4a'];} ?>">
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="q4b" class="form-control input-md" placeholder="£" value="<?php if(isset($data3['q4b'])) { echo $data3['q4b'];} ?>">
                        </div>
                        
                        <div class="col-md-12">
                            <label class="col-md-12 control-label" for="q4c" style="color:red;">How much are you covered for?</label>
                            <input type="text" name="q4c" class="form-control input-md" placeholder="£" value="<?php if(isset($data3['q4c'])) { echo $data3['q4c'];} ?>">
                        </div>
                        
                        <div class="col-md-12">
                            <label class="col-md-12 control-label" for="q4d" style="color:red;">How long do you have left on the policy?</label>
                            <input type="text" name="q4d" class="form-control input-md" value="<?php if(isset($data3['q4d'])) { echo $data3['q4d'];} ?>">
                        </div>
                        ...
                        <center>
                            ...
                            <div class="col-md-12">
                                <label class="radio-inline" for="q4e-0" style="color:blue;">
                                    <input name="q4e" id="radios-0" q4e="1" type="radio" <?php if(isset($data3['q4e'])) { if($data3['q4e']=='1') { echo "checked"; } } ?>>
                                    Single Policy
                                </label> 
                                <label class="radio-inline" for="q4e-1" style="color:blue;">
                                    <input name="q4e" id="radios-1" q4e="2" type="radio" <?php if(isset($data3['q4e'])) { if($data3['q4e']=='2') { echo "checked"; } } ?>>
                                    Joint Policy
                                </label> 
                                <label class="radio-inline" for="q4e-2" style="color:blue;">
                                    <input name="q4e" id="q4e-2" value="3" type="radio" <?php if(isset($data3['q4e'])) { if($data3['q4e']=='3') { echo "checked"; } } ?>>
                                    Separate Policies
                                </label> 
                            </div>
                        </center>
                        ...
                        <div class="col-md-12"> 
                            ...
                            <label class="radio-inline" for="q5a-0">
                                <input name="q5a" id="q5a-0" value="1" type="radio" <?php if(isset($data3['q5a'])) { if($data3['q5a']=='1') { echo "checked"; } } ?>>
                                You
                            </label> 
                            <label class="radio-inline" for="q5a-1">
                                <input name="q5a" id="q5a-1" value="2" type="radio" <?php if(isset($data3['q5a'])) { if($data3['q5a']=='2') { echo "checked"; } } ?>>
                        ...
                        <div class="col-md-12"> 
                            ...
                            <label class="radio-inline" for="q6a-0">
                                <input name="q6a" id="q6a-0" value="1" type="radio" <?php if(isset($data3['q6a'])) { if($data3['q6a']=='1') { echo "checked"; } } ?>>
                                You
                            </label> 
                            <label class="radio-inline" for="q6a-1">
                                <input name="q6a" id="q6a-1" value="2" type="radio" <?php if(isset($data3['q6a'])) { if($data3['q6a']=='2') { echo "checked"; } } ?>>
                                Partner (if applicable)
                            </label> 
                            
                            <input type="text" name="q6b" class="form-control input-md" value="<?php if(isset($data3['q6b'])) { echo $data3['q6b'];} ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4"> 
                                <label class="radio-inline" for="q7a-0">
                                    <input name="q7a" id="q7a-0" value="1" type="radio" <?php if(isset($data3['q7a'])) { if($data3['q7a']=='1') { echo "checked"; } } ?>>
                                    Reduce Premium
                                </label> 
                                <label class="radio-inline" for="q7a-1">
                                    <input name="q7a" id="q7a-1" value="2" type="radio" <?php if(isset($data3['q7a'])) { if($data3['q7a']=='2') { echo "checked"; } } ?>>
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="comments" class="form-control input-md" value="<?php if(isset($data3['comments'])) { echo $data3['comments'];} ?>">
                            </div> 
                            
                            <div class="col-md-6">
                                <label class="col-md-12 control-label" for="callback">Callback time</label>
                                <input type="text" name="callback" class="form-control input-md" value="<?php if(isset($data3['callback'])) { echo $data3['callback'];} ?>">
                            </div>
                        </div>
                ...
                <div class="panel panel-danger">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="exist_pol" class="form-control input-md" placeholder="Existing policy number" value="<?php if(isset($data4['exist_pol'])) { echo $data4['exist_pol'];} ?>">
                        </div>
                        
                        <div class="col-md-6">
                            <p>
                                <label for="closer">CLOSER NAME:</label>
                                <input type='text' id='closer' name='closer' class="form-control" value="<?php if(isset($data2['closer'])) { echo $data2['closer'];} ?>" readonly>
                            </p>
                            <br>
                        </div>
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" name="pol_1_num" class="form-control input-md" placeholder="New Policy Number" value="<?php if(isset($data4['pol_num_1'])) { echo $data4['pol_num_1'];} ?>">
                        </div>
                        
                        <div class="col-md-1">
                            <label class="col-md-2 control-label" for="pol_1_pre">PREMIUM</label>
                            <input type="text" name="pol_1_pre" class="form-control input-md" placeholder="£" value="<?php if(isset($data4['pol_num_1_pre'])) { echo $data4['pol_num_1_pre'];} ?>">
                        </div>
                        
                        <div class="col-md-1">
                            <label class="col-md-2 control-label" for="pol_1_com">COMM</label>
                            <input type="text" name="pol_1_com" class="form-control input-md" placeholder="£" value="<?php if(isset($data4['pol_num_1_com'])) { echo $data4['pol_num_1_com'];} ?>">
                        </div>
                        
                        <div class="col-md-1">
                            <label class="col-md-2 control-label" for="pol_1_cov">COVER</label>
                            <input type="text" name="pol_1_cov" class="form-control input-md" placeholder="Cover" value="<?php if(isset($data4['pol_num_1_cov'])) { echo $data4['pol_num_1_cov'];} ?>">  
                        </div>
                        
                        <div class="col-md-1">
                            <label class="col-md-2 control-label" for="pol_1_yr">YRS</label>
                            <input type="text" name="pol_1_yr" class="form-control input-md" placeholder="Years" value="<?php if(isset($data4['pol_num_1_yr'])) { echo $data4['pol_num_1_yr'];} ?>">
                        </div>
                        
                        <div class="col-md-5">
                            <label class="checkbox-inline" for="pol_1_type-0">
                                <input name="pol_1_type" id="pol_1_type-0" value="1" type="checkbox" <?php if(isset($data4['pol_num_1_type'])) { if($data4['pol_num_1_type']=='1') { echo "checked" ;} } ?>>
                                LTA
                            </label> 
                            <label class="checkbox-inline" for="pol_1_type-1">
                                <input name="pol_1_type" id="pol_1_type-1" value="2" type="checkbox" <?php if(isset($data4['pol_num_1_type'])) { if($data4['pol_num_1_type']=='2') { echo "checked" ;} } ?>>
                                LTA CIC
                            </label> 
                            <label class="checkbox-inline" for="pol_1_type-2">
                                <input name="pol_1_type" id="pol_1_type-2" value="3" type="checkbox" <?php if(isset($data4['pol_num_1_type'])) { if($data4['pol_num_1_type']=='3') { echo "checked" ;} } ?>>>
                                DTA
                            </label> 
                            <label class="checkbox-inline" for="pol_1_type-3">
                                <input name="pol_1_type" id="pol_1_type-3" value="4" type="checkbox" <?php if(isset($data4['pol_num_1_type'])) { if($data4['pol_num_1_type']=='4') { echo "checked" ;} } ?>>
                                DTA CIC
                            </label> 
                            <label class="checkbox-inline" for="checkboxes-4">
                                <input name="pol_1_type" id="pol_1_type-4" value="5" type="checkbox" <?php if(isset($data4['pol_num_1_type'])) { if($data4['pol_num_1_type']=='5') { echo "checked" ;} } ?>>
                                CIC
                            </label> 
                        </div>
                        ...
                        <div class="col-md-1">
                            ...
                            <input type="text" name="pol_1_soj" class="form-control input-md" placeholder="" value="<?php if(isset($data4['pol_num_2_soj'])) { echo $data4['pol_num_2_soj'];} ?>">
                        </div>
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" name="pol_2_num" class="form-control input-md" placeholder="New Policy Number" value="<?php if(isset($data4['pol_num_2'])) { echo $data4['pol_num_2'];} ?>"> 
                        </div>
                        
                        <div class="col-md-1">
                            <label class="col-md-2 control-label" for="pol_2_pre">PREMIUM</label>
                            <input type="text" name="pol_2_pre" class="form-control input-md" placeholder="£" value="<?php if(isset($data4['pol_num_2_pre'])) { echo $data4['pol_num_2_pre'];} ?>">
                        </div>
                        
                        <div class="col-md-1">
                            <label class="col-md-2 control-label" for="pol_2_com">COMM</label>
                            <input type="text" name="pol_2_com" class="form-control input-md" placeholder="£" value="<?php if(isset($data4['pol_num_2_com'])) { echo $data4['pol_num_2_com'];} ?>">
                        </div>
                        
                        <div class="col-md-1">
                            <label class="col-md-2 control-label" for="pol_2_cov">COVER</label>
                            <input type="text" name="pol_2_cov" class="form-control input-md" placeholder="Cover" value="<?php if(isset($data4['pol_num_2_cov'])) { echo $data4['pol_num_2_cov'];} ?>">  
                        </div>
                        
                        <div class="col-md-1">
                            <label class="col-md-2 control-label" for="pol_2_yr">YRS</label>
                            <input type="text" name="pol_2_yr" class="form-control input-md" placeholder="Years" value="<?php if(isset($data4['pol_num_2_yr'])) { echo $data4['pol_num_2_yr'];} ?>">
                        </div>
                        
                        <div class="col-md-5">
                            <label class="checkbox-inline" for="pol_2_type-0">
                                <input name="pol_2_type" id="pol_2_type-0" value="1" type="checkbox" <?php if(isset($data4['pol_num_2_type'])) { if($data4['pol_num_2_type']=='1') { echo "checked" ;} } ?>>
                                LTA
                            </label> 
                            <label class="checkbox-inline" for="pol_2_type-1">
                                <input name="pol_2_type" id="pol_2_type-1" value="2" type="checkbox" <?php if(isset($data4['pol_num_2_type'])) { if($data4['pol_num_2_type']=='2') { echo "checked" ;} } ?>>
                                LTA CIC
                            </label> 
                            <label class="checkbox-inline" for="pol_2_type-2">
                                <input name="pol_2_type" id="pol_2_type-2" value="3" type="checkbox" <?php if(isset($data4['pol_num_2_type'])) { if($data4['pol_num_2_type']=='3') { echo "checked" ;} } ?>>
                                DTA
                            </label> 
                            <label class="checkbox-inline" for="pol_2_type-3">
                                <input name="pol_2_type" id="pol_2_type-3" value="4" type="checkbox" <?php if(isset($data4['pol_num_2_type'])) { if($data4['pol_num_2_type']=='4') { echo "checked" ;} } ?>>
                                DTA CIC
                            </label> 
                            <label class="checkbox-inline" for="checkboxes-4">
                                <input name="pol_2_type" id="pol_2_type-4" value="5" type="checkbox" <?php if(isset($data4['pol_num_2_type'])) { if($data4['pol_num_2_type']=='5') { echo "checked" ;} } ?>>
                                CIC
                            </label> 
                        </div>
                        ...
                        <div class="col-md-1">
                            ...
                            <input type="text" name="pol_2_soj" class="form-control input-md" placeholder="" value="<?php if(isset($data4['pol_num_3_soj'])) { echo $data4['pol_num_3_soj'];} ?>">
                        </div>
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" name="pol_3_num" class="form-control input-md" placeholder="New Policy Number" value="<?php if(isset($data4['pol_num_3'])) { echo $data4['pol_num_3'];} ?>">
                        </div>
                        
                        <div class="col-md-1">
                            <label class="col-md-2 control-label" for="pol_3_pre">PREMIUM</label>
                            <input type="text" name="pol_3_pre" class="form-control input-md" placeholder="£" value="<?php if(isset($data4['pol_num_3_pre'])) { echo $data4['pol_num_3_pre'];} ?>">
                        </div>
                        
                        <div class="col-md-1">
                            <label class="col-md-2 control-label" for="pol_3_com">COMM</label>
                            <input type="text" name="pol_3_com" class="form-control input-md" placeholder="£" value="<?php if(isset($data4['pol_num_3_com'])) { echo $data4['pol_num_3_com'];} ?>">
                        </div>
                        
                        <div class="col-md-1">
                            <label class="col-md-2 control-label" for="pol_3_cov">COVER</label>
                            <input type="text" name="pol_3_cov" class="form-control input-md" placeholder="Cover" value="<?php if(isset($data4['pol_num_3_cov'])) { echo $data4['pol_num_3_cov'];} ?>">  
                        </div>
                        
                        <div class="col-md-1">
                            <label class="col-md-2 control-label" for="pol_3_yr">YRS</label>
                            <input type="text" name="pol_3_yr" class="form-control input-md" placeholder="Years" value="<?php if(isset($data4['pol_num_3_yr'])) { echo $data4['pol_num_3_yr'];} ?>">
                        </div>
                        
                        <div class="col-md-5">
                            <label class="checkbox-inline" for="pol_3_type-0">
                                <input name="pol_3_type" id="pol_3_type-0" value="1" type="checkbox" <?php if(isset($data4['pol_num_3_type'])) { if($data4['pol_num_3_type']=='1') { echo "checked" ;} } ?>>
                                LTA
                            </label> 
                            <label class="checkbox-inline" for="pol_3_type-1">
                                <input name="pol_3_type" id="pol_3_type-1" value="2" type="checkbox" <?php if(isset($data4['pol_num_3_type'])) { if($data4['pol_num_3_type']=='2') { echo "checked" ;} } ?>>
                                LTA CIC
                            </label> 
                            <label class="checkbox-inline" for="pol_3_type-2">
                                <input name="pol_3_type" id="pol_3_type-2" value="3" type="checkbox" <?php if(isset($data4['pol_num_3_type'])) { if($data4['pol_num_3_type']=='3') { echo "checked" ;} } ?>>
                                DTA
                            </label> 
                            <label class="checkbox-inline" for="pol_3_type-3">
                                <input name="pol_3_type" id="pol_3_type-3" value="4" type="checkbox" <?php if(isset($data4['pol_num_3_type'])) { if($data4['pol_num_3_type']=='4') { echo "checked" ;} } ?>>
                                DTA CIC
                            </label> 
                            <label class="checkbox-inline" for="checkboxes-4">
                                <input name="pol_3_type" id="pol_3_type-4" value="5" type="checkbox" <?php if(isset($data4['pol_num_3_type'])) { if($data4['pol_num_3_type']=='5') { echo "checked" ;} } ?>>
                                CIC
                            </label> 
                        </div>
                        ...
                        <div class="col-md-1">
                            ...
                            <input type="text" name="pol_3_soj" class="form-control input-md" placeholder="" value="<?php if(isset($data4['pol_num_3_soj'])) { echo $data4['pol_num_3_soj'];} ?>">
                        </div>
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" name="pol_4_num" class="form-control input-md" placeholder="New Policy Number" value="<?php if(isset($data4['pol_num_4'])) { echo $data4['pol_num_4'];} ?>">
                        </div>
                        
                        <div class="col-md-1">
                            <label class="col-md-2 control-label" for="pol_4_pre">PREMIUM</label>
                            <input type="text" name="pol_4_pre" class="form-control input-md" placeholder="£" value="<?php if(isset($data4['pol_num_4_pre'])) { echo $data4['pol_num_4_pre'];} ?>">
                        </div>
                        
                        <div class="col-md-1">
                            <label class="col-md-2 control-label" for="pol_4_com">COMM</label>
                            <input type="text" name="pol_4_com" class="form-control input-md" placeholder="£" value="<?php if(isset($data4['pol_num_4_com'])) { echo $data4['pol_num_4_com'];} ?>">
                        </div>
                        
                        <div class="col-md-1">
                            <label class="col-md-2 control-label" for="pol_4_cov">COVER</label>
                            <input type="text" name="pol_4_cov" class="form-control input-md" placeholder="Cover" value="<?php if(isset($data4['pol_num_4_cov'])) { echo $data4['pol_num_4_cov'];} ?>">
                        </div>
                        
                        <div class="col-md-1">
                            <label class="col-md-2 control-label" for="pol_4_yr">YRS</label>
                            <input type="text" name="pol_4_yr" class="form-control input-md" placeholder="Years" value="<?php if(isset($data4['pol_num_4_yr'])) { echo $data4['pol_num_4_yr'];} ?>">
                        </div>
                        
                        <div class="col-md-5">
                            <label class="checkbox-inline" for="pol_4_type-0">
                                <input name="pol_4_type" id="pol_4_type-0" value="1" type="checkbox" <?php if(isset($data4['pol_num_4_type'])) { if($data4['pol_num_4_type']=='1') { echo "checked" ;} } ?>>
                                LTA
                            </label> 
                            <label class="checkbox-inline" for="pol_4_type-1">
                                <input name="pol_4_type" id="pol_4_type-1" value="2" type="checkbox" <?php if(isset($data4['pol_num_4_type'])) { if($data4['pol_num_4_type']=='2') { echo "checked" ;} } ?>>
                                LTA CIC
                            </label> 
                            <label class="checkbox-inline" for="pol_4_type-2">
                                <input name="pol_4_type" id="pol_4_type-2" value="3" type="checkbox" <?php if(isset($data4['pol_num_4_type'])) { if($data4['pol_num_4_type']=='3') { echo "checked" ;} } ?>>
                                DTA
                            </label> 
                            <label class="checkbox-inline" for="pol_4_type-3">
                                <input name="pol_4_type" id="pol_4_type-3" value="4" type="checkbox" <?php if(isset($data4['pol_num_4_type'])) { if($data4['pol_num_4_type']=='4') { echo "checked" ;} } ?>>
                                DTA CIC
                            </label> 
                            <label class="checkbox-inline" for="checkboxes-4">
                                <input name="pol_4_type" id="pol_4_type-4" value="5" type="checkbox" <?php if(isset($data4['pol_num_4_type'])) { if($data4['pol_num_4_type']=='5') { echo "checked" ;} } ?>>
                                CIC
                            </label> 
                        </div>
                        ...
                        <div class="col-md-1">
                            ...
                            <input type="text" name="pol_4_soj" class="form-control input-md" placeholder="" value="<?php if(isset($data4['pol_num_4_soj'])) { echo $data4['pol_num_4_soj'];} ?>">
                        </div> 
                        ...
                        <div class="col-md-12"> 
                            ...
                            <label class="checkbox-inline" for="checkboxes-0">
                                <input name="chk_postcode" id="chk_postcode-0" value="1" type="checkbox" <?php if(isset($data4['chk_post'])) { if($data4['chk_post']=='1') { echo "checked" ;} } ?>>
                                POST CODE
                            </label> 
                            <label class="checkbox-inline" for="chk_dob-1">
                                <input name="chk_dob" id="chk_dob-1" value="1" type="checkbox" <?php if(isset($data4['chk_dob'])) { if($data4['chk_dob']=='1') { echo "checked" ;} } ?>>
                                DOB
                            </label> 
                            <label class="checkbox-inline" for="chk_mob-0">
                                <input name="chk_mob" id="chk_mob-0" value="1" type="checkbox" <?php if(isset($data4['chk_mob'])) { if($data4['chk_mob']=='1') { echo "checked" ;} } ?>>
                                MOBILE NO
                            </label> 
                            <label class="checkbox-inline" for="chk_home-0">
                                <input name="chk_home" id="chk_home-0" value="1" type="checkbox" <?php if(isset($data4['chk_home'])) { if($data4['chk_home']=='1') { echo "checked" ;} } ?>>
                                HOME NO
                            </label> 
                            <label class="checkbox-inline" for="chk_email-0">
                                <input name="chk_email" id="chk_email-0" value="1" type="checkbox" <?php if(isset($data4['chk_email'])) { if($data4['chk_email']=='1') { echo "checked" ;} } ?>>
                                EMAIL
                            </label> 
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="col-md-2">
                                ...
                                <input type="text" name="fee" class="form-control input-md" placeholder="£" value="<?php if(isset($data4['fee'])) { echo $data4['fee'];} ?>">
                            </div>
                            
                            <div class="col-md-2">
                                <label class="col-md-4 control-label" for="total">COMMS</label>
                                <input type="text" name="total" class="form-control input-md" placeholder="£" value="<?php if(isset($data4['total'])) { echo $data4['total'];} ?>"> 
                            </div>
                            
                            <div class="col-md-1">
                                <label class="col-md-4 control-label" for="years">YEARS</label>
                                <input type="text" name="years" class="form-control input-md" placeholder="Years" value="<?php if(isset($data4['years'])) { echo $data4['years'];} ?>">
                            </div>
                            
                            <div class="col-md-1">
                                <label class="col-md-4 control-label" for="month">MONTHS</label>
                                <input type="text" name="month" class="form-control input-md" placeholder="Months" value="<?php if(isset($data4['month'])) { echo $data4['month'];} ?>">
                            </div>
                            
                            <div class="col-md-2">
                                <label class="col-md-4 control-label" for="comm_after">COMMSAFTER</label>
                                <input type="text" name="comm_after" class="form-control input-md" placeholder="" value="<?php if(isset($data4['comm_after'])) { echo $data4['comm_after'];} ?>">
                            </div>
                            
                            <div class="col-md-1">
                                <label class="col-md-4 control-label" for="sac">SAC</label>
                                <input type="text" name="sac" class="form-control input-md" placeholder="%" value="<?php if(isset($data4['sac'])) { echo $data4['sac'];} ?>">
                            </div>
                            
                            <div class="col-md-2">
                                <label class="col-md-4 control-label" for="closer_date">DATE</label>
                                <input type="text" name="closer_date" class="form-control input-md" placeholder="" value="<?php if(isset($data4['date'])) { echo $data4['date'];} ?>"> 
                            </div>
...
list($dob_year2, $dob_month2, $dob_day2) = explode(" ", $data2['dob2']);
 ...
 <div class="container">
                  <div class="container">
<?php include('../includes/adl_features.php');
if($ffpost_code=='1') { 
...
<div class="form-group">
 ...
 <option value="">Select...</option>
        <option value="Mr" <?php if(isset($data2['title'])) { if($data2['title']=='Mr') { echo "selected"; } } ?>>Mr</option>       
        <option value="Dr" <?php if(isset($data2['title'])) { if($data2['title']=='Dr') { echo "selected"; } } ?>>Dr</option>
        <option value="Miss" <?php if(isset($data2['title'])) { if($data2['title']=='Miss') { echo "selected"; } } ?>>Miss</option>
        <option value="Mrs" <?php if(isset($data2['title'])) { if($data2['title']=='Mrs') { echo "selected"; } } ?>>Mrs</option>
        <option value="Ms" <?php if(isset($data2['title'])) { if($data2['title']=='Ms') { echo "selected"; } } ?>>Ms</option>
        <option value="Other" <?php if(isset($data2['title'])) { if($data2['title']=='Other') { echo "selected"; } } ?>>Other</option>
  </select>
</div>
            </p>
            ...
            <p>
                ...
                <input type="text" id="first_name" name="first_name" class="form-control" style="width: 170px" required value="<?php if(isset($data2['forename'])) { echo $data2['forename']; } ?>">
            </p>
            <p>
                <label for="last_name">Last Name:</label>
                <input type="text" id="last_name" name="last_name" class="form-control" style="width: 170px" required value="<?php if(isset($data2['surname'])) { echo $data2['surname']; } ?>">
            </p>
            <p>
                <label for="dob">Date of Birth:</label>
                <input type="text" id="dob" name="dob" class="form-control" style="width: 170px" required value="<?php if(isset($dob_day)) { echo "$dob_year-$dob_month-$dob_day"; } ?>">
            </p>
            <p>
                <label for="email">Email:</label>
                <input type="email" id="email" class="form-control" style="width: 170px" name="email" value="<?php if(isset($data2['email'])) { echo $data2['email']; } ?>">
            </p>
...
<div class="form-group">
 ...
 <option value="">Select...</option>
        <option value="Mr" <?php if(isset($data2['title2'])) { if($data2['title2']=='Mr') { echo "selected"; } } ?>>Mr</option>       
        <option value="Dr" <?php if(isset($data2['title2'])) { if($data2['title2']=='Dr') { echo "selected"; } } ?>>Dr</option>
        <option value="Miss" <?php if(isset($data2['title2'])) { if($data2['title2']=='Miss') { echo "selected"; } } ?>>Miss</option>
        <option value="Mrs" <?php if(isset($data2['title2'])) { if($data2['title2']=='Mrs') { echo "selected"; } } ?>>Mrs</option>
        <option value="Ms" <?php if(isset($data2['title2'])) { if($data2['title2']=='Ms') { echo "selected"; } } ?>>Ms</option>
        <option value="Other" <?php if(isset($data2['title2'])) { if($data2['title2']=='Other') { echo "selected"; } } ?>>Other</option>
  </select>
</div>
            </p>
            ...
            <p>
                ...
                <input type="text" id="first_name2" name="first_name2" class="form-control" style="width: 170px" value="<?php if(isset($data2['forename2'])) { echo $data2['forename2']; } ?>">
            </p>
            <p>
                <label for="last_name2">Last Name:</label>
                <input type="text" id="last_name2" name="last_name2" class="form-control" style="width: 170px" value="<?php if(isset($data2['surname2'])) { echo $data2['surname2']; } ?>">
            </p>
            <p>
                <label for="dob2">Date of Birth:</label>
                <input type="text" id="dob2" name="dob2" class="form-control" style="width: 170px" value="<?php if(isset($dob_day2)) { echo "$dob_year2-$dob_month2-$dob_day2"; } ?>">
            </p>
            <p>
...
<br>
            ...
            <p>
                ...
                <input type="tel" id="phone_number" name="phone_number" class="form-control" style="width: 170px" required pattern=".{11}|.{11,12}" maxlength="12" title="Enter a valid phone number" value="<?php if(isset($data2['mobile'])) { echo $data2['mobile']; } ?>">
            </p>
            <p>
                <label for="alt_number">Alt Number:</label>
                <input type="tel" id="alt_number" name="alt_number" class="form-control" style="width: 170px" pattern=".{11}|.{11,12}" maxlength="12" title="Enter a valid phone number" value="<?php if(isset($data2['home'])) { echo $data2['home']; } ?>">
            </p>
<br>
            ...
            <p>
                ...
                <input type="text" id="post_code" name="post_code" class="form-control" style="width: 170px" required value="<?php if(isset($data2['postcode'])) { echo $data2['postcode']; } ?>">
            </p>
...
<option value="<?php echo "$title $forname $lastname and $title2 $forname2 $surname2"; ?>" <?php if(isset($data4['pol_1_soj'])) { if($data4['pol_1_soj']=='J') { echo "selected"; } } ?>><?php echo "$title $forname $lastname and $title2 $forname2 $surname2"; ?></option>
</select>
</p>   
...
<div class="form-group">
  ...
  <select class="form-control" name="soj" id="soj" style="width: 170px" required>
      <option value="">Select...</option>
<option value="Single" <?php if(isset($data4['pol_num_1_soj'])) { if($data4['pol_num_1_soj']=='S') { echo "selected"; } } ?>>Single</option>
<option value="Joint" <?php if(isset($data4['pol_num_1_soj'])) { if($data4['pol_num_1_soj']=='J') { echo "selected"; } } ?>>Joint</option>
  </select>
</div>
</p>
...
<input type='text' id='policy_number' name='policy_number' placeholder="For WOL use One Family" class="form-control" autocomplete="off" style="width: 170px" placeholder="TBC" value="<?php if(isset($data4['pol_num_1'])) { echo $data4['pol_num_1']; } ?>">
</p>
...
<div class="form-group">
  ...
  <option value="">Select...</option>
  <option value="LTA" <?php if(isset($data4['pol_num_1_type'])) { if($data4['pol_num_1_type']=='1') { echo "selected"; } } ?>>LTA</option>
  <option value="LTA SIC" <?php if(isset($data4['pol_num_1_type'])) { if($data4['pol_num_1_type']=='LTA SIC') { echo "selected"; } } ?>>LTA SIC (Vitality)</option>
  <option value="LTA CIC" <?php if(isset($data4['pol_num_1_type'])) { if($data4['pol_num_1_type']=='2') { echo "selected"; } } ?>>LTA + CIC</option>
  <option value="DTA" <?php if(isset($data4['pol_num_1_type'])) { if($data4['pol_num_1_type']=='3') { echo "selected"; } } ?>>DTA</option>
  <option value="DTA CIC" <?php if(isset($data4['pol_num_1_type'])) { if($data4['pol_num_1_type']=='4') { echo "selected"; } } ?>>DTA + CIC</option>
  <option value="CIC" <?php if(isset($data4['pol_num_1_type'])) { if($data4['pol_num_1_type']=='5') { echo "selected"; } } ?>>CIC</option>
  <option value="FPIP" <?php if(isset($data4['pol_num_1_type'])) { if($data4['pol_num_1_type']=='FPIP') { echo "selected"; } } ?>>FPIP</option>
  <option value="WOL" <?php if(isset($data4['pol_num_1_type'])) { if($data4['pol_num_1_type']=='WOL') { echo "selected"; } } ?>>WOL</option>
  </select>
</div>
</p>
...
<p>
 <div class="form-row">
    ...
    <div class="input-group"> 
        ...
        <input style="width: 140px" autocomplete="off" type="number" min="0" step="0.01" data-number-to-fixed="2" data-number-stepfactor="100" class="form-control currency" id="premium" name="premium" required value="<?php if(isset($data4['pol_num_1_pre'])) { echo  $data4['pol_num_1_pre']; } ?>"/>
    </div> 
 </div>
</p>
...
<p>
 <div class="form-row">
    ...
    <div class="input-group"> 
        <span class="input-group-addon">£</span>
        <input style="width: 140px" autocomplete="off" type="number" min="0" step="0.01" data-number-to-fixed="2" data-number-stepfactor="100" class="form-control currency" id="commission" name="commission" required value="<?php if(isset($data4['pol_num_1_com'])) { echo $data4['pol_num_1_com']; } ?>"/>
    </div> 
         </div>
</p>
...
<p>
 <div class="form-row">
    ...
    <div class="input-group"> 
        <span class="input-group-addon">£</span>
        <input style="width: 140px" autocomplete="off" type="number" min="0" step="0.01" data-number-to-fixed="2" data-number-stepfactor="100" class="form-control currency" id="covera" name="covera" required value="<?php if(isset($data4['pol_num_1_cov'])) { echo $data4['pol_num_1_cov']; } ?>"/>
    </div> 
         </div>
</p>
...
<p>
 <div class="form-row">
    ...
    <div class="input-group"> 
        ...
        <input style="width: 140px" autocomplete="off" type="text" class="form-control" id="polterm" name="polterm" required value="<?php if(isset($data4['pol_num_1_yr'])) { echo $data4['pol_num_1_yr']; } ?>"/>
    </div> 
         </div>
</p>
</div>
...
<input type='text' id='closer' name='closer' style="width: 170px" class="form-control" style="width: 170px" required value="<?php if(isset($data2['closer'])) { echo $data2['closer']; } ?>">
</p>
    <script>var options = {
...
<input type='text' id='lead' name='lead' style="width: 170px" class="form-control" style="width: 170px" required value="<?php if(isset($data2['agent'])) { echo $data2['agent']; } ?>">
</p>
<script>var options = {
...
<option value="<?php echo "$title $forname $surname"; ?>"><?php echo "$title $forname $surname"; ?></option>
<option value="<?php echo "$title2 $forname2 $surname2"; ?>"><?php echo "$title $forname2 $surname2"; ?></option>
<option value="<?php echo "$title $forname $lastname and $title2 $forname2 $surname2"; ?>" <?php if(isset($data4['pol_num_2_soj'])) { if($data4['pol_num_2_soj']=='J') { echo "selected"; } } ?>><?php echo "$title $forname $lastname and $title2 $forname2 $surname2"; ?></option>
</select>
</p>   
...
<div class="form-group">
  ...
  <select class="form-control" name="soj" id="soj" style="width: 170px" required>
      <option value="">Select...</option>
<option value="Single" <?php if(isset($data4['pol_num_2_soj'])) { if($data4['pol_num_2_soj']=='S') { echo "selected"; } } ?>>Single</option>
<option value="Joint" <?php if(isset($data4['pol_num_2_soj'])) { if($data4['pol_num_2_soj']=='J') { echo "selected"; } } ?>>Joint</option>
  </select>
</div>
</p>
...
<p>
<label for="policy_number">Policy Number:</label>
<input type='text' id='policy_number' name='policy_number' class="form-control" placeholder="For WOL use One Family" autocomplete="off" style="width: 170px" placeholder="TBC" value="<?php if(isset($data4['pol_num_2'])) { echo $data4['pol_num_2']; } ?>">
</p>
...
<div class="form-group">
  ...
  <select class="form-control" name="type" id="type" style="width: 170px" required>
  <option value="">Select...</option>
  <option value="LTA" <?php if(isset($data4['pol_num_2_type'])) { if($data4['pol_num_2_type']=='1') { echo "selected"; } } ?>>LTA</option>
  <option value="LTA SIC" <?php if(isset($data4['pol_num_2_type'])) { if($data4['pol_num_2_type']=='LTA SIC') { echo "selected"; } } ?>>LTA SIC (Vitality)</option>
  <option value="LTA CIC" <?php if(isset($data4['pol_num_2_type'])) { if($data4['pol_num_2_type']=='2') { echo "selected"; } } ?>>LTA + CIC</option>
  <option value="DTA" <?php if(isset($data4['pol_num_2_type'])) { if($data4['pol_num_2_type']=='3') { echo "selected"; } } ?>>DTA</option>
  <option value="DTA CIC" <?php if(isset($data4['pol_num_2_type'])) { if($data4['pol_num_2_type']=='4') { echo "selected"; } } ?>>DTA + CIC</option>
  <option value="CIC" <?php if(isset($data4['pol_num_2_type'])) { if($data4['pol_num_2_type']=='5') { echo "selected"; } } ?>>CIC</option>
  <option value="FPIP" <?php if(isset($data4['pol_num_2_type'])) { if($data4['pol_num_2_type']=='FPIP') { echo "selected"; } } ?>>FPIP</option>
  <option value="WOL" <?php if(isset($data4['pol_num_2_type'])) { if($data4['pol_num_2_type']=='WOL') { echo "selected"; } } ?>>WOL</option>
  </select>
</div>
</p>
...
<p>
 <div class="form-row">
    ...
    <div class="input-group"> 
        <span class="input-group-addon">£</span>
        <input style="width: 140px" autocomplete="off" type="number" min="0" step="0.01" data-number-to-fixed="2" data-number-stepfactor="100" class="form-control currency" id="premium" name="premium" required value="<?php if(isset($data4['pol_num_2_pre'])) { echo  $data4['pol_num_2_pre']; } ?>"/>
    </div> 
 </div>
</p>
...
<p>
 <div class="form-row">
    ...
    <div class="input-group"> 
        <span class="input-group-addon">£</span>
        <input style="width: 140px" autocomplete="off" type="number" min="0" step="0.01" data-number-to-fixed="2" data-number-stepfactor="100" class="form-control currency" id="commission" name="commission" required value="<?php if(isset($data4['pol_num_2_com'])) { echo $data4['pol_num_2_com']; } ?>"/>
    </div> 
         </div>
</p>
...
<p>
 <div class="form-row">
    ...
    <div class="input-group"> 
        <span class="input-group-addon">£</span>
        <input style="width: 140px" autocomplete="off" type="number" min="0" step="0.01" data-number-to-fixed="2" data-number-stepfactor="100" class="form-control currency" id="covera" name="covera" required value="<?php if(isset($data4['pol_num_2_cov'])) { echo $data4['pol_num_2_cov']; } ?>"/>
    </div> 
         </div>
</p>
...
<p>
 <div class="form-row">
    ...
    <div class="input-group"> 
        <span class="input-group-addon">yrs</span>
        <input style="width: 140px" autocomplete="off" type="text" class="form-control" id="polterm" name="polterm" required value="<?php if(isset($data4['pol_num_2_yr'])) { echo $data4['pol_num_2_yr']; } ?>"/>
    </div> 
         </div>
</p>
</div>
...
<option value="<?php echo "$title $forname $surname"; ?>"><?php echo "$title $forname $surname"; ?></option>
<option value="<?php echo "$title2 $forname2 $surname2"; ?>"><?php echo "$title $forname2 $surname2"; ?></option>
<option value="<?php echo "$title $forname $lastname and $title2 $forname2 $surname2"; ?>" <?php if(isset($data4['pol_num_3_soj'])) { if($data4['pol_num_3_soj']=='J') { echo "selected"; } } ?>><?php echo "$title $forname $lastname and $title2 $forname2 $surname2"; ?></option>
</select>
</p>   
...
<div class="form-group">
  ...
  <select class="form-control" name="soj" id="soj" style="width: 170px" required>
      <option value="">Select...</option>
<option value="Single" <?php if(isset($data4['pol_num_3_soj'])) { if($data4['pol_num_3_soj']=='S') { echo "selected"; } } ?>>Single</option>
<option value="Joint" <?php if(isset($data4['pol_num_3_soj'])) { if($data4['pol_num_3_soj']=='J') { echo "selected"; } } ?>>Joint</option>
  </select>
</div>
</p>
...
<p>
<label for="policy_number">Policy Number:</label>
<input type='text' id='policy_number' name='policy_number' placeholder="For WOL use One Family" class="form-control" autocomplete="off" style="width: 170px" placeholder="TBC" value="<?php if(isset($data4['pol_num_3'])) { echo $data4['pol_num_3']; } ?>">
</p>
...
<div class="form-group">
  ...
  <select class="form-control" name="type" id="type" style="width: 170px" required>
  <option value="">Select...</option>
  <option value="LTA" <?php if(isset($data4['pol_num_3_type'])) { if($data4['pol_num_3_type']=='1') { echo "selected"; } } ?>>LTA</option>
  <option value="LTA SIC" <?php if(isset($data4['pol_num_3_type'])) { if($data4['pol_num_3_type']=='LTA SIC') { echo "selected"; } } ?>>LTA SIC (Vitality)</option>
  <option value="LTA CIC" <?php if(isset($data4['pol_num_3_type'])) { if($data4['pol_num_3_type']=='2') { echo "selected"; } } ?>>LTA + CIC</option>
  <option value="DTA" <?php if(isset($data4['pol_num_3_type'])) { if($data4['pol_num_3_type']=='3') { echo "selected"; } } ?>>DTA</option>
  <option value="DTA CIC" <?php if(isset($data4['pol_num_3_type'])) { if($data4['pol_num_3_type']=='4') { echo "selected"; } } ?>>DTA + CIC</option>
  <option value="CIC" <?php if(isset($data4['pol_num_3_type'])) { if($data4['pol_num_3_type']=='5') { echo "selected"; } } ?>>CIC</option>
  <option value="FPIP" <?php if(isset($data4['pol_num_3_type'])) { if($data4['pol_num_3_type']=='FPIP') { echo "selected"; } } ?>>FPIP</option>
  <option value="WOL" <?php if(isset($data4['pol_num_3_type'])) { if($data4['pol_num_3_type']=='WOL') { echo "selected"; } } ?>>WOL</option>
  </select>
</div>
</p>
...
<p>
 <div class="form-row">
    ...
    <div class="input-group"> 
        <span class="input-group-addon">£</span>
        <input style="width: 140px" autocomplete="off" type="number" min="0" step="0.01" data-number-to-fixed="2" data-number-stepfactor="100" class="form-control currency" id="premium" name="premium" required value="<?php if(isset($data4['pol_num_3_pre'])) { echo  $data4['pol_num_3_pre']; } ?>"/>
    </div> 
 </div>
</p>
...
<p>
 <div class="form-row">
    ...
    <div class="input-group"> 
        <span class="input-group-addon">£</span>
        <input style="width: 140px" autocomplete="off" type="number" min="0" step="0.01" data-number-to-fixed="2" data-number-stepfactor="100" class="form-control currency" id="commission" name="commission" required value="<?php if(isset($data4['pol_num_3_com'])) { echo $data4['pol_num_3_com']; } ?>"/>
    </div> 
         </div>
</p>
...
<p>
 <div class="form-row">
    ...
    <div class="input-group"> 
        <span class="input-group-addon">£</span>
        <input style="width: 140px" autocomplete="off" type="number" min="0" step="0.01" data-number-to-fixed="2" data-number-stepfactor="100" class="form-control currency" id="covera" name="covera" required value="<?php if(isset($data4['pol_num_3_cov'])) { echo $data4['pol_num_3_cov']; } ?>"/>
    </div> 
         </div>
</p>
...
<p>
 <div class="form-row">
    ...
    <div class="input-group"> 
        <span class="input-group-addon">yrs</span>
        <input style="width: 140px" autocomplete="off" type="text" class="form-control" id="polterm" name="polterm" required value="<?php if(isset($data4['pol_num_3_yr'])) { echo $data4['pol_num_3_yr']; } ?>"/>
    </div> 
         </div>
</p>
</div>
...
<option value="<?php echo "$title $forname $surname"; ?>"><?php echo "$title $forname $surname"; ?></option>
<option value="<?php echo "$title2 $forname2 $surname2"; ?>"><?php echo "$title $forname2 $surname2"; ?></option>
<option value="<?php echo "$title $forname $lastname and $title2 $forname2 $surname2"; ?>" <?php if(isset($data4['pol_num_4_soj'])) { if($data4['pol_num_4_soj']=='J') { echo "selected"; } } ?>><?php echo "$title $forname $lastname and $title2 $forname2 $surname2"; ?></option>
</select>
</p>   
...
<div class="form-group">
  ...
  <select class="form-control" name="soj" id="soj" style="width: 170px" required>
      <option value="">Select...</option>
<option value="Single" <?php if(isset($data4['pol_num_4_soj'])) { if($data4['pol_num_4_soj']=='S') { echo "selected"; } } ?>>Single</option>
<option value="Joint" <?php if(isset($data4['pol_num_4_soj'])) { if($data4['pol_num_4_soj']=='J') { echo "selected"; } } ?>>Joint</option>
  </select>
</div>
</p>
...
<p>
<label for="policy_number">Policy Number:</label>
<input type='text' id='policy_number' name='policy_number' placeholder="For WOL use One Family" class="form-control" autocomplete="off" style="width: 170px" placeholder="TBC" value="<?php if(isset($data4['pol_num_4'])) { echo $data4['pol_num_4']; } ?>">
</p>
...
<div class="form-group">
  ...
  <select class="form-control" name="type" id="type" style="width: 170px" required>
  <option value="">Select...</option>
  <option value="LTA" <?php if(isset($data4['pol_num_4_type'])) { if($data4['pol_num_4_type']=='1') { echo "selected"; } } ?>>LTA</option>
  <option value="LTA SIC" <?php if(isset($data4['pol_num_4_type'])) { if($data4['pol_num_4_type']=='LTA SIC') { echo "selected"; } } ?>>LTA SIC (Vitality)</option>
  <option value="LTA CIC" <?php if(isset($data4['pol_num_4_type'])) { if($data4['pol_num_4_type']=='2') { echo "selected"; } } ?>>LTA + CIC</option>
  <option value="DTA" <?php if(isset($data4['pol_num_4_type'])) { if($data4['pol_num_4_type']=='3') { echo "selected"; } } ?>>DTA</option>
  <option value="DTA CIC" <?php if(isset($data4['pol_num_4_type'])) { if($data4['pol_num_4_type']=='4') { echo "selected"; } } ?>>DTA + CIC</option>
  <option value="CIC" <?php if(isset($data4['pol_num_4_type'])) { if($data4['pol_num_4_type']=='5') { echo "selected"; } } ?>>CIC</option>
  <option value="FPIP" <?php if(isset($data4['pol_num_4_type'])) { if($data4['pol_num_4_type']=='FPIP') { echo "selected"; } } ?>>FPIP</option>
  <option value="WOL" <?php if(isset($data4['pol_num_4_type'])) { if($data4['pol_num_4_type']=='WOL') { echo "selected"; } } ?>>WOL</option>
  </select>
</div>
</p>
...
<p>
 <div class="form-row">
    ...
    <div class="input-group"> 
        <span class="input-group-addon">£</span>
        <input style="width: 140px" autocomplete="off" type="number" min="0" step="0.01" data-number-to-fixed="2" data-number-stepfactor="100" class="form-control currency" id="premium" name="premium" required value="<?php if(isset($data4['pol_num_4_pre'])) { echo  $data4['pol_num_4_pre']; } ?>"/>
    </div> 
 </div>
</p>
...
<p>
 <div class="form-row">
    ...
    <div class="input-group"> 
        <span class="input-group-addon">£</span>
        <input style="width: 140px" autocomplete="off" type="number" min="0" step="0.01" data-number-to-fixed="2" data-number-stepfactor="100" class="form-control currency" id="commission" name="commission" required value="<?php if(isset($data4['pol_num_4_com'])) { echo $data4['pol_num_4_com']; } ?>"/>
    </div> 
         </div>
</p>
...
<p>
 <div class="form-row">
    ...
    <div class="input-group"> 
        <span class="input-group-addon">£</span>
        <input style="width: 140px" autocomplete="off" type="number" min="0" step="0.01" data-number-to-fixed="2" data-number-stepfactor="100" class="form-control currency" id="covera" name="covera" required value="<?php if(isset($data4['pol_num_4_cov'])) { echo $data4['pol_num_4_cov']; } ?>"/>
    </div> 
         </div>
</p>
...
<p>
 <div class="form-row">
    ...
    <div class="input-group"> 
        <span class="input-group-addon">yrs</span>
        <input style="width: 140px" autocomplete="off" type="text" class="form-control" id="polterm" name="polterm" required value="<?php if(isset($data4['pol_num_4_yr'])) { echo $data4['pol_num_4_yr']; } ?>"/>
    </div> 
         </div>
</p>
</div>
  ...
  ++$INCyear;
                ...
                <div class="panel panel-danger">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-1">
                            <label class="col-md-4 control-label" for="pol_1_soj">S/J 1,2?</label>
                            <input type="text" name="pol_1_soj" class="form-control input-md" placeholder="" value="<?php if(isset($data4['pol_num_1_soj'])) { echo $data4['pol_num_1_soj'];} ?>">
                        </div>
  ...
  <div class="container">
      ...
      <?php echo "<h4>$Today_TIME</h4>"; ?>
                ...
                <?php }
                                ...
                                if($QUERY=='AllCloserTrackers') {           
                                    
                                    $TrackerEdit= filter_input(INPUT_GET, 'TrackerEdit', FILTER_SANITIZE_SPECIAL_CHARS);
                                    $CloserSelect= filter_input(INPUT_POST, 'CloserSelect', FILTER_SANITIZE_SPECIAL_CHARS);
                                    $EditCloser= filter_input(INPUT_GET, 'EditCloser', FILTER_SANITIZE_SPECIAL_CHARS);
                                    
                                    $TRACKER_day= filter_input(INPUT_POST, 'TRACKER_day', FILTER_SANITIZE_SPECIAL_CHARS);
                                    $TRACKER_month= filter_input(INPUT_POST, 'TRACKER_month', FILTER_SANITIZE_SPECIAL_CHARS);
                                    $TRACKER_year= filter_input(INPUT_POST, 'TRACKER_year', FILTER_SANITIZE_SPECIAL_CHARS);
                                    $SETDATES= filter_input(INPUT_POST, 'SETDATES', FILTER_SANITIZE_SPECIAL_CHARS);
                                    $TRACKER_day_COM="$TRACKER_year-$TRACKER_month-$TRACKER_day"
  ...
  <div class="container">
      ...
      <?php echo "<h4>$Today_TIME</h4>"; ?>
                    ...
                    <div class="list-group">
                        ...
                        <br><br>
                        <form action="?query=AllCloserTrackers&CloserSelected" method="post" name="CloserSelectForm" id="CloserSelectForm">
                        
                            <div class="col-md-12">
                                <div class="col-md-4">
                            <select class="form-control" name="CloserSelect" id="CloserSelect">
                                <?php if(isset($CloserSelect)) { ?>
                                <option value="<?php echo $CloserSelect; ?>"><?php echo $CloserSelect; ?></option>
                                <?php } else { ?>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-2"> 
                                        <select class="form-control input-md" name="TRACKER_day">
                                            <?php
                                        if(isset($TRACKER_day)) {
                                        ?>
                                        <option value="<?php echo $TRACKER_day; ?>"><?php echo $TRACKER_day; ?></option>
                                        <?php } else { ?>
                                        <option value="">Day</option>
                                        <?php } ?>
                                            <option value="01">01</option>
                                    ...
                                    <div class="col-md-2"> 
                                        <select class="form-control input-md" name="TRACKER_month">
                                                  <?php
                                        if(isset($TRACKER_month)) {
                                        ?>
                                        <option value="<?php echo $TRACKER_month; ?>"><?php echo $TRACKER_month; ?></option>
                                        <?php } else { ?>
                                        <option value="">Month</option>
                                        <?php } ?>
                                    ...
                                    <div class="col-md-2">
                                        <select class="form-control input-md" name="TRACKER_year">
                                            <?php
                                        if(isset($TRACKER_year)) {
                                        ?>
...
for ($i = 0; $i <= 100; ++$i)
{
  ...
  ++$INCyear;
                                ...
                                <form method="post" action="<?php if(isset($TrackerEdit)) { echo 'php/Tracker.php?query=Alledit'; } ?>">
                ...
                $TRACKER_EDIT->execute();
                        ...
                        <td><input size="12" class="form-control" type="text" name="agent_name" id="provider-json" value="<?php if(isset($TRK_EDIT_agent)) { echo $TRK_EDIT_agent; } ?>"></td>                      
      ...
      <?php echo "<h4>$Today_TIME</h4>"; ?>
                    ...
                    <div class="list-group">
                        <span class="label label-primary"><?php echo $real_name; ?> Trackers</span>
                                <form method="post" action="<?php if(isset($TrackerEdit)) { echo 'php/Tracker.php?query=edit'; } else { echo 'php/Tracker.php?query=add'; } ?>">
<table id="tracker" class="table table-hover">
                        <thead>
                            <tr>
                                <th>Agent</th>
