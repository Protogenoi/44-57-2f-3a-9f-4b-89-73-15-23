...
<div class="container">
                  ...
                  if(isset($fflife)) { 
                    ...
                    $query = $pdo->prepare("SELECT CONCAT(callback_time, ' - ', callback_date) AS calltimeid, CONCAT(callback_date, ' - ',callback_time)AS ordersort, client_id, id, client_name, notes, complete from scheduled_callbacks WHERE assign=:hello ORDER BY ordersort DESC");
