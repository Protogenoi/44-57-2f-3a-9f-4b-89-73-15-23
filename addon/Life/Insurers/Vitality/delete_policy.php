...
-->
        <html lang="en">
            <title>ADL | Delete Vitality Policy</title>
            <meta charset="UTF-8">
        ...
        <div class="panel-heading">Delete <?php if(isset($data2['adl_policy_policy_holder'])) { echo $data2['adl_policy_policy_holder'];  } ?> Vitality Policy</div>
