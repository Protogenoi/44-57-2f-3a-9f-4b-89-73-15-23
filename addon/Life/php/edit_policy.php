...
$database->query("UPDATE adl_policy SET 
 ...
 adl_policy_id=:APID");
            ...
            $database->query("UPDATE aegon_policy SET 
 aegon_policy_ref=:REF,
 aegon_policy_plan=:PLAN,
 aegon_policy_type=:TYPE,
 aegon_policy_cover_Type=:COVER_TYPE,
 aegon_policy_sic_opt=:SIC_OPT,
 aegon_policy_term_prem=:TERM_PREM,
 aegon_policy_wellness=:VITAL,
