...
$AEGON_COM_QRY = $pdo->prepare("UPDATE
  ...
  $AEGON_C_EXTRA_QRY->bindParam(':H1', $H_C1, PDO::PARAM_STR);
    $AEGON_C_EXTRA_QRY->bindParam(':H2', $H_C2, PDO::PARAM_STR); 
    $AEGON_C_EXTRA_QRY->bindParam(':H3', $H_C3, PDO::PARAM_STR); 
    $AEGON_C_EXTRA_QRY->bindParam(':H4', $H_C4, PDO::PARAM_STR);      
    $AEGON_C_EXTRA_QRY->bindParam(':H5', $H_C5, PDO::PARAM_STR);      
    $AEGON_C_EXTRA_QRY->bindParam(':D1', $D_C1, PDO::PARAM_STR);
    $AEGON_C_EXTRA_QRY->bindParam(':D2', $D_C2, PDO::PARAM_STR); 
    $AEGON_C_EXTRA_QRY->bindParam(':D3', $D_C3, PDO::PARAM_STR); 
    $AEGON_C_EXTRA_QRY->bindParam(':D4', $D_C4, PDO::PARAM_STR); 
    $AEGON_C_EXTRA_QRY->bindParam(':BD1', $BD_C1, PDO::PARAM_STR);
    $AEGON_C_EXTRA_QRY->bindParam(':BD2', $BD_C2, PDO::PARAM_STR);
    $AEGON_C_EXTRA_QRY->bindParam(':BD3', $BD_C3, PDO::PARAM_STR);
    $AEGON_C_EXTRA_QRY->bindParam(':BD4', $BD_C4, PDO::PARAM_STR);
    $AEGON_C_EXTRA_QRY->bindParam(':BD5', $BD_C5, PDO::PARAM_STR);   
    $AEGON_C_EXTRA_QRY->bindParam(':DEC1', $DEC_C1, PDO::PARAM_STR);
    $AEGON_C_EXTRA_QRY->bindParam(':DEC2', $DEC_C2, PDO::PARAM_STR);
    $AEGON_C_EXTRA_QRY->bindParam(':DEC3', $DEC_C3, PDO::PARAM_STR);
    $AEGON_C_EXTRA_QRY->bindParam(':DEC4', $DEC_C4, PDO::PARAM_STR);
    $AEGON_C_EXTRA_QRY->bindParam(':DEC5', $DEC_C5, PDO::PARAM_STR);
    $AEGON_C_EXTRA_QRY->bindParam(':DEC6', $DEC_C6, PDO::PARAM_STR);
    $AEGON_C_EXTRA_QRY->bindParam(':DEC7', $DEC_C7, PDO::PARAM_STR); 
    $AEGON_C_EXTRA_QRY->bindParam(':QC1', $QC_C1, PDO::PARAM_STR);
    $AEGON_C_EXTRA_QRY->bindParam(':QC2', $QC_C2, PDO::PARAM_STR);
    $AEGON_C_EXTRA_QRY->bindParam(':QC3', $QC_C3, PDO::PARAM_STR);
    $AEGON_C_EXTRA_QRY->bindParam(':QC4', $QC_C4, PDO::PARAM_STR);
    $AEGON_C_EXTRA_QRY->bindParam(':QC5', $QC_C5, PDO::PARAM_STR);
    $AEGON_C_EXTRA_QRY->bindParam(':QC6', $QC_C6, PDO::PARAM_STR);
    $AEGON_C_EXTRA_QRY->bindParam(':QC7', $QC_C7, PDO::PARAM_STR);
