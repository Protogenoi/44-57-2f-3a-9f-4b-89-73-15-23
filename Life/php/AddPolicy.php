...
header('Location: ../../Life/ViewClient.php?policyadded=y&search='.$CID.'&dupepolicy='.$dupepol.'&origpolicy='.$policy_number); die;     
    }
}
 }
...
header('Location: ../../Life/ViewClient.php?policyadded=y&search='.$CID.'&policy_number='.$policy_number); die;
    }
}
?>