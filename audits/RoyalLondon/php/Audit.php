...
if(isset($fferror)) {
    ...
    $fk_audit_id = $pdo->lastInsertId();    
    
    if(isset($fk_audit_id)) {
    ...
    $RL_QS->bindParam(':fk_audit_id', $fk_audit_id, PDO::PARAM_STR, 100);
    ...
    $RL_COM->bindParam(':fk_audit_id', $fk_audit_id, PDO::PARAM_STR, 100);
    ...
    $RL_QS_EX->bindParam(':fk_audit_id',$fk_audit_id,PDO::PARAM_STR,100);
    ...
    $RL_COM_ETX->bindParam(':fk_audit_id',$fk_audit_id,PDO::PARAM_STR,100);
