...
define("LOGIN_PAGE", CLASS_PATH."dev.adlcrm.com");
define("START_PAGE", "../../CRMmain.php");
define("ACTIVE_PASS_PAGE", APPLICATION_PATH."activate_password.php");
define("DENY_ACCESS_PAGE", APPLICATION_PATH."../../error/403.php");
define("ADMIN_PAGE", APPLICATION_PATH."../admin/user.php");
