...
if ($companynamere == 'Bluestone Protect') {
    ...
    $Level_1_Access = array("Archiver","Michael", "Matt", "leighton", "Nick", "Abbiek", "Carys Riley", "carys", "Jakob", "Nicola", "Tina", 'Heidy', 'Amy', "Audits", "Rhiannon", "Ryan", "TEST", "Assured","Keith","David","Darryl","Gavin","James Adams");
    ...
    $GOOD_SEARH_ACCESS=array("James Adams","Michael","Matt","carys","Nicola","Abbiek","leighton","Nick","Jakob","Tina","Carys Riley","Archiver");
