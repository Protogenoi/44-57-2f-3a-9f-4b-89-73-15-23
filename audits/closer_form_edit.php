...
<select class="form-control" name="grade" required>
  ...
  <option value="SAVED" <?php if ($result['grade']=="SAVED") echo "selected"?>>Incomplete Audit</option>
  <option value="Green" <?php if ($result['grade']=="Green") echo "selected"?>>Green</option>
  <option value="Amber" <?php if ($result['grade']=="Amber") echo "selected"?>>Amber</option>
  <option value="Red" <?php if ($result['grade']=="Red") echo "selected"?>>Red</option>
</select>
</div>
 </div>
...
<input type="radio" name="q1" value="Yes"  <?php if ($result['q1']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q1" value="No" <?php if ($result['q1']=="No") echo "checked"?>>No
...
<!--
<input type="text" name="q2" maxlength = "3" value="<?php echo $result[q2]?>" > 
-->
<input type="radio" name="q2" value="Yes"  <?php if ($result['q2']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q2" value="No" <?php if ($result['q2']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q2contest" value="Contested" <?php if ($result['q2contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q2outcome" value="Outcome" <?php if ($result['q2outcome']) echo 'checked="checked"'?>> Outcome<br>-->
</p>
...
<!--
<input type="text" name="q3" maxlength = "3" value="<?php echo $result[q3]?>" > 
-->
<input type="radio" name="q3" value="Yes"  <?php if ($result['q3']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q3" value="No" <?php if ($result['q3']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q3contest" value="Contested" <?php if ($result['q3contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q3outcome" value="Outcome" <?php if ($result['q3outcome']) echo 'checked="checked"'?>> Outcome<br>-->
</p>
...
<!--
<input type="text" name="q4" maxlength = "3" value="<?php echo $result[q4]?>" > 
-->

<input type="radio" name="q4" value="Yes"  <?php if ($result['q4']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q4" value="No" <?php if ($result['q4']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q4contest" value="Contested" <?php if ($result['q4contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q4outcome" value="Outcome" <?php if ($result['q4outcome']) echo 'checked="checked"'?>> Outcome<br>-->
</p>
...
<!--
<input type="text" name="q5" maxlength = "3" value="<?php echo $result[q5]?>" > 
-->
<input type="radio" name="q5" value="Yes"  <?php if ($result['q5']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q5" value="No" <?php if ($result['q5']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q5contest" value="Contested" <?php if ($result['q5contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q5outcome" value="Outcome" <?php if ($result['q5outcome']) echo 'checked="checked"'?>> Outcome<br>-->
</p>
...
<!--
<input type="text" name="q6" maxlength = "3" value="<?php echo $result[q6]?>" > 
-->
<input type="radio" name="q6" value="Yes"  <?php if ($result['q6']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q6" value="No" <?php if ($result['q6']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q6contest" value="Contested" <?php if ($result['q6contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q6outcome" value="Outcome" <?php if ($result['q6outcome']) echo 'checked="checked"'?>> Outcome<br>-->
</p>
...
<!--
<input type="text" name="q7" maxlength = "3" value="<?php echo $result[q7]?>" > 
-->
<input type="radio" name="q7" value="Yes"  <?php if ($result['q7']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q7" value="No" <?php if ($result['q7']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q7contest" value="Contested" <?php if ($result['q7contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q7outcome" value="Outcome" <?php if ($result['q7outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q8" maxlength = "3" value="<?php echo $result[q8]?>" > 
-->
<input type="radio" name="q8" value="Yes"  <?php if ($result['q8']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q8" value="No" <?php if ($result['q8']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q8contest" value="Contested" <?php if ($result['q8contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q8outcome" value="Outcome" <?php if ($result['q8outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q9" maxlength = "3" value="<?php echo $result[q9]?>" > 
-->
<input type="radio" name="q9" value="Yes"   <?php if ($result['q9']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q9" value="No" <?php if ($result['q9']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q9contest" value="Contested" <?php if ($result['q9contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q9outcome" value="Outcome" <?php if ($result['q9outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q10" maxlength = "3" value="<?php echo $result[q10]?>" > 
-->
<input type="radio" name="q10" value="Yes"  <?php if ($result['q10']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q10" value="No" <?php if ($result['q10']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q10contest" value="Contested" <?php if ($result['q10contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q10outcome" value="Outcome" <?php if ($result['q10outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q11" maxlength = "3" value="<?php echo $result[q11]?>" > 
-->
<input type="radio" name="q11" value="Yes"  <?php if ($result['q11']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q11" value="No" <?php if ($result['q11']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q11contest" value="Contested" <?php if ($result['q11contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q11outcome" value="Outcome" <?php if ($result['q11outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q12" maxlength = "3" value="<?php echo $result[q12]?>" > 
-->
<input type="radio" name="q12" value="Yes"  <?php if ($result['q12']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q12" value="No" <?php if ($result['q12']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q12contest" value="Contested" <?php if ($result['q12contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q12outcome" value="Outcome" <?php if ($result['q12outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q53" maxlength = "3" value="<?php echo $result[q53]?>" > 
-->
<input type="radio" name="q53" value="Yes"  <?php if ($result['q53']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q53" value="No" <?php if ($result['q53']=="No") echo "checked"?>>No
<input type="radio" name="q53" value="N/A" <?php if ($result['q53']=="N/A") echo "checked"?>>N/A


<!--<input type="checkbox" name="q53contest" value="Contested" <?php if ($result['q53contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q53outcome" value="Outcome" <?php if ($result['q53outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q13" maxlength = "3" value="<?php echo $result[q13]?>" > 
-->
<input type="radio" name="q13" value="Yes"  <?php if ($result['q13']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q13" value="No" <?php if ($result['q13']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q13contest" value="Contested" <?php if ($result['q13contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q13outcome" value="Outcome" <?php if ($result['q13outcome']) echo 'checked="checked"'?>> Outcome<br>-->
</p>
...
<!--
<input type="text" name="q14" maxlength = "20" value="<?php echo $result[q14]?>" > 
-->
<select name="q14" >
  <option value="NA">Select...</option>
<option value="More than sufficient" <?php if ($result['q14']=="More than sufficient") echo "selected"?>>More than sufficient</option>
<option value="Sufficient" <?php if ($result['q14']=="Sufficient") echo "selected"?>>Sufficient</option>
<option value="Adaquate" <?php if ($result['q14']=="Adaquate") echo "selected"?>>Adaquate</option>
<option value="Poor" <?php if ($result['q14']=="Poor") echo "selected"?>>Poor</option>
</select>


<!--<input type="checkbox" name="q14contest" value="Contested" <?php if ($result['q14contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q14outcome" value="Outcome" <?php if ($result['q14outcome']) echo 'checked="checked"'?>> Outcome<br>-->
</p>
...
<!--
<input type="text" name="q15" maxlength = "3" value="<?php echo $result[q15]?>" > 
-->
<input type="radio" name="q15" value="Yes"  <?php if ($result['q15']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q15" value="No" <?php if ($result['q15']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q15contest" value="Contested" <?php if ($result['q15contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q15outcome" value="Outcome" <?php if ($result['q15outcome']) echo 'checked="checked"'?>> Outcome<br>-->
</p>
...
<!--
<input type="text" name="q55" maxlength = "3" value="<?php echo $result[q55]?>" > 
-->
<input type="radio" name="q55" value="Yes"  <?php if ($result['q55']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q55" value="No" <?php if ($result['q55']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q55contest" value="Contested" <?php if ($result['q55contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q55outcome" value="Outcome" <?php if ($result['q55outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q17" maxlength = "3" value="<?php echo $result[q17]?>" > 
-->
<input type="radio" name="q17" value="Yes"  <?php if ($result['q17']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q17" value="No" <?php if ($result['q17']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q17contest" value="Contested" <?php if ($result['q17contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q17outcome" value="Outcome" <?php if ($result['q17outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q16" maxlength = "3" value="<?php echo $result[q16]?>" > 
-->
<input type="radio" name="q16" value="Yes"  <?php if ($result['q16']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q16" value="No" <?php if ($result['q16']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q16contest" value="Contested" <?php if ($result['q16contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q16outcome" value="Outcome" <?php if ($result['q16outcome']) echo 'checked="checked"'?>> Outcome<br>-->
</p>
...
<!--
<input type="text" name="q31" maxlength = "3" value="<?php echo $result[q31]?>" > 
-->
<input type="radio" name="q31" value="Yes"  <?php if ($result['q31']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q31" value="No" <?php if ($result['q31']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q31contest" value="Contested" <?php if ($result['q31contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q31outcome" value="Outcome" <?php if ($result['q31outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q18" maxlength = "3" value="<?php echo $result[q18]?>" > 
-->
<input type="radio" name="q18" value="Yes"  <?php if ($result['q18']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q18" value="No" <?php if ($result['q18']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q18contest" value="Contested" <?php if ($result['q18contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q18outcome" value="Outcome" <?php if ($result['q18outcome']) echo 'checked="checked"'?>> Outcome<br>-->
</p>
...
<!--
<input type="text" name="q19" maxlength = "3" value="<?php echo $result[q19]?>" > 
-->
<input type="radio" name="q19" value="Yes"  <?php if ($result['q19']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q19" value="No" <?php if ($result['q19']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q19contest" value="Contested" <?php if ($result['q19contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q19outcome" value="Outcome" <?php if ($result['q19outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q20" maxlength = "3" value="<?php echo $result[q20]?>" > 
-->
<input type="radio" name="q20" value="Yes"  <?php if ($result['q20']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q20" value="No" <?php if ($result['q20']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q20contest" value="Contested" <?php if ($result['q20contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q20outcome" value="Outcome" <?php if ($result['q20outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q21" maxlength = "3" value="<?php echo $result[q21]?>" > 
-->
<input type="radio" name="q21" value="Yes"  <?php if ($result['q21']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q21" value="No" <?php if ($result['q21']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q21contest" value="Contested" <?php if ($result['q21contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q21outcome" value="Outcome" <?php if ($result['q21outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q22" maxlength = "3" value="<?php echo $result[q22]?>" >
-->
<input type="radio" name="q22" value="Yes"  <?php if ($result['q22']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q22" value="No" <?php if ($result['q22']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q22contest" value="Contested" <?php if ($result['q22contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q22outcome" value="Outcome" <?php if ($result['q22outcome']) echo 'checked="checked"'?>> Outcome<br>--> 
...
<!--
<input type="text" name="q23" maxlength = "3" value="<?php echo $result[q23]?>" > 
-->
<input type="radio" name="q23" value="Yes"  <?php if ($result['q23']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q23" value="No" <?php if ($result['q23']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q23contest" value="Contested" <?php if ($result['q23contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q23outcome" value="Outcome" <?php if ($result['q23outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q24" maxlength = "3" value="<?php echo $result[q24]?>" > 
-->
<input type="radio" name="q24" value="Yes"  <?php if ($result['q24']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q24" value="No" <?php if ($result['q24']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q24contest" value="Contested" <?php if ($result['q24contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q24outcome" value="Outcome" <?php if ($result['q24outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q25" maxlength = "3" value="<?php echo $result[q25]?>" > 
-->
<input type="radio" name="q25" value="Yes"  <?php if ($result['q25']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q25" value="No" <?php if ($result['q25']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q25contest" value="Contested" <?php if ($result['q25contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q25outcome" value="Outcome" <?php if ($result['q25outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q26" maxlength = "3" value="<?php echo $result[q26]?>" > 
-->
<input type="radio" name="q26" value="Yes"  <?php if ($result['q26']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q26" value="No" <?php if ($result['q26']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q26contest" value="Contested" <?php if ($result['q26contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q26outcome" value="Outcome" <?php if ($result['q26outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q27" maxlength = "3" value="<?php echo $result[q27]?>" > 
-->
<input type="radio" name="q27" value="Yes"  <?php if ($result['q27']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q27" value="No" <?php if ($result['q27']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q27contest" value="Contested" <?php if ($result['q27contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q27outcome" value="Outcome" <?php if ($result['q27outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q28" maxlength = "3" value="<?php echo $result[q28]?>" > 
-->
<input type="radio" name="q28" value="Yes"  <?php if ($result['q28']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q28" value="No" <?php if ($result['q28']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q28contest" value="Contested" <?php if ($result['q28contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q28outcome" value="Outcome" <?php if ($result['q28outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q29" maxlength = "52" value="<?php echo $result[q29]?>" > 
-->
<select name="q29" >
  <option value="NA">Select...</option>
  <option value="Client provided details" <?php if ($result['q29']=="Client provided details") echo "selected"?>>Client Provided Details</option>
  <option value="Client failed to provide details" <?php if ($result['q29']=="Client failed to provide details") echo "selected"?>>Client failed to provided details</option>
  <option value="Not existing L&G customer" <?php if ($result['q29']=="Not existing L&G customer") echo "selected"?>>Not existing legal and general customer</option>
  <option value="Obtained from Term4Term service" <?php if ($result['q29']=="Obtained from Term4Term service") echo "selected"?>>Obtained from Term4Term service</option>
  <option value="Existing L&G Policy, no attempt to get policy number" <?php if ($result['q29']=="Existing L&G Policy, no attempt to get policy number") echo "selected"?>>Existing L&G Policy, no attempt to get policy number</option>
</select>


<!--<input type="checkbox" name="q29contest" value="Contested" <?php if ($result['q29contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q29outcome" value="Outcome" <?php if ($result['q29outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q30" maxlength = "3" value="<?php echo $result[q30]?>" > 
-->
<input type="radio" name="q30" value="Yes"  <?php if ($result['q30']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q30" value="No" <?php if ($result['q30']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q30contest" value="Contested" <?php if ($result['q30contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q30outcome" value="Outcome" <?php if ($result['q30outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<br>
<p>
<label for="q54">Q34. If appropirate did the agent confirm the exclusions on the policy</label>

<input type="radio" name="q54" value="Yes"  <?php if ($result['q54']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q54" value="No" <?php if ($result['q54']=="No") echo "checked"?>>No
<input type="radio" name="q54" value="N/A" <?php if ($result['q54']=="N/A") echo "checked"?>>N/A
</p>
...
<!--
<input type="text" name="q32" maxlength = "3" value="<?php echo $result[q32]?>" > 
-->
<input type="radio" name="q32" value="Yes"  <?php if ($result['q32']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q32" value="No" <?php if ($result['q32']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q32contest" value="Contested" <?php if ($result['q32contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q32outcome" value="Outcome" <?php if ($result['q32outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q33" maxlength = "3" value="<?php echo $result[q33]?>" > 
-->
<input type="radio" name="q33" value="Yes"  <?php if ($result['q33']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q33" value="No" <?php if ($result['q33']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q33contest" value="Contested" <?php if ($result['q33contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q33outcome" value="Outcome" <?php if ($result['q33outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q34" maxlength = "3" value="<?php echo $result[q34]?>" > 
-->
<input type="radio" name="q34" value="Yes"  <?php if ($result['q34']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q34" value="No" <?php if ($result['q34']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q34contest" value="Contested" <?php if ($result['q34contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q34outcome" value="Outcome" <?php if ($result['q34outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q35" maxlength = "3" value="<?php echo $result[q35]?>" > 
-->
<input type="radio" name="q35" value="Yes"  <?php if ($result['q35']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q35" value="No" <?php if ($result['q35']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q35contest" value="Contested" <?php if ($result['q35contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q35outcome" value="Outcome" <?php if ($result['q35outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q36" maxlength = "3" value="<?php echo $result[q36]?>" > 
-->
<input type="radio" name="q36" value="Yes"  <?php if ($result['q36']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q36" value="No" <?php if ($result['q36']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q36contest" value="Contested" <?php if ($result['q36contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q36outcome" value="Outcome" <?php if ($result['q36outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<p>
<label for="q37">Q37. Did The Sales Agent Confirm Who The Policy Is With And The Length Of The Policy?</label>

<input type="text" name="q37" maxlength = "3" value="<?php echo $result[q37]?>" > 

<input type="radio" name="q37" value="Yes"  <?php if ($result['q37']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q37" value="No" <?php if ($result['q37']=="No") echo "checked"?>>No
...
Comments: 
<br>
<textarea name="c37" rows="1" cols="85" maxlength="500" onkeyup="textAreaAdjust(this)" id="textarea37"><?php echo $result[c37]?></textarea>
<div id="textarea_feedbackc8"></div>
<script>
$(document).ready(function() {
    var text_max = 500;
...
<script type="text/javascript">
textAreaAdjust(document.getElementById("textarea37"));
</script>


<!--<input type="checkbox" name="q37contest" value="Contested" <?php if ($result['q37contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q37outcome" value="Outcome" <?php if ($result['q37outcome']) echo 'checked="checked"'?>> Outcome<br>-->
</p>
...
<!--
<input type="text" name="q38" maxlength = "3" value="<?php echo $result[q38]?>" > 
-->
<input type="radio" name="q38" value="Yes"  <?php if ($result['q38']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q38" value="No" <?php if ($result['q38']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q38contest" value="Contested" <?php if ($result['q38contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q38outcome" value="Outcome" <?php if ($result['q38outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q39" maxlength = "3" value="<?php echo $result[q39]?>" > 
-->
<input type="radio" name="q39" value="Yes"  <?php if ($result['q39']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q39" value="No" <?php if ($result['q39']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q39contest" value="Contested" <?php if ($result['q39contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q39outcome" value="Outcome" <?php if ($result['q39outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q40" maxlength = "3" value="<?php echo $result[q40]?>" > 
-->
<input type="radio" name="q40" value="Yes"  <?php if ($result['q40']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q40" value="No" <?php if ($result['q40']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q40contest" value="Contested" <?php if ($result['q40contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q40outcome" value="Outcome" <?php if ($result['q40outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q41" maxlength = "3" value="<?php echo $result[q41]?>" > 
-->
<input type="radio" name="q41" value="Yes"  <?php if ($result['q41']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q41" value="No" <?php if ($result['q41']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q41contest" value="Contested" <?php if ($result['q41contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q41outcome" value="Outcome" <?php if ($result['q41outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q42" maxlength = "3" value="<?php echo $result[q42]?>" > 
-->
<input type="radio" name="q42" value="Yes"  <?php if ($result['q42']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q42" value="No" <?php if ($result['q42']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q42contest" value="Contested" <?php if ($result['q42contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q42outcome" value="Outcome" <?php if ($result['q42outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q43" maxlength = "3" value="<?php echo $result[q43]?>" > 
-->
<input type="radio" name="q43" value="Yes"  <?php if ($result['q43']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q43" value="No" <?php if ($result['q43']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q43contest" value="Contested" <?php if ($result['q43contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q43outcome" value="Outcome" <?php if ($result['q43outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q44" maxlength = "3" value="<?php echo $result[q44]?>" >
-->
<input type="radio" name="q44" value="Yes"  <?php if ($result['q44']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q44" value="No" <?php if ($result['q44']=="No") echo "checked"?>>No



<!--<input type="checkbox" name="q44contest" value="Contested" <?php if ($result['q44contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q44outcome" value="Outcome" <?php if ($result['q44outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q45" maxlength = "3" value="<?php echo $result[q45]?>" > 
-->
<input type="radio" name="q45" value="Yes"  <?php if ($result['q45']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q45" value="No" <?php if ($result['q45']=="No") echo "checked"?>>No
<input type="radio" name="q45" value="N/A" <?php if ($result['q45']=="N/A") echo "checked"?>>N/A


<!--<input type="checkbox" name="q45contest" value="Contested" <?php if ($result['q45contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q45outcome" value="Outcome" <?php if ($result['q45outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q46" maxlength = "3" value="<?php echo $result[q46]?>" >
-->
<input type="radio" name="q46" value="Yes"  <?php if ($result['q46']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q46" value="No" <?php if ($result['q46']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q46contest" value="Contested" <?php if ($result['q46contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q46outcome" value="Outcome" <?php if ($result['q46outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q47" maxlength = "3" value="<?php echo $result[q47]?>" > 
-->
<input type="radio" name="q47" value="Yes"  <?php if ($result['q47']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q47" value="No" <?php if ($result['q47']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q47contest" value="Contested" <?php if ($result['q47contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q47outcome" value="Outcome" <?php if ($result['q47outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q48" maxlength = "3" value="<?php echo $result[q48]?>" >
-->
<input type="radio" name="q48" value="Yes"  <?php if ($result['q48']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q48" value="No" <?php if ($result['q48']=="No") echo "checked"?>>No 


<!--<input type="checkbox" name="q48contest" value="Contested" <?php if ($result['q48contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q48outcome" value="Outcome" <?php if ($result['q48outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q49" maxlength = "3" value="<?php echo $result[q49]?>" > 
-->
<input type="radio" name="q49" value="Yes"  <?php if ($result['q49']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q49" value="No" <?php if ($result['q49']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q49contest" value="Contested" <?php if ($result['q49contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q49outcome" value="Outcome" <?php if ($result['q49outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<!--
<input type="text" name="q50" maxlength = "3" value="<?php echo $result[q50]?>" > 
-->
<input type="radio" name="q50" value="Yes"  <?php if ($result['q50']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q50" value="No" <?php if ($result['q50']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q50contest" value="Contested" <?php if ($result['q50contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q50outcome" value="Outcome" <?php if ($result['q50outcome']) echo 'checked="checked"'?>> Outcome<br>-->
...
<p>
<label for="q51">Q53. Did The Agent Provide Contact Details For The Review Bureau?</label>
<!--
<input type="text" name="q51" maxlength = "3" value="<?php echo $result[q51]?>" >
-->
<input type="radio" name="q51" value="Yes"  <?php if ($result['q51']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q51" value="No" <?php if ($result['q51']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q51contest" value="Contested" <?php if ($result['q51contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q51outcome" value="Outcome" <?php if ($result['q51outcome']) echo 'checked="checked"'?>> Outcome<br>--> 
...
<!--
<input type="text" name="q52" maxlength = "3" value="<?php echo $result[q52]?>" > 
-->
<input type="radio" name="q52" value="Yes"  <?php if ($result['q52']=="Yes") echo "checked"?>>Yes
<input type="radio" name="q52" value="No" <?php if ($result['q52']=="No") echo "checked"?>>No


<!--<input type="checkbox" name="q52contest" value="Contested" <?php if ($result['q52contest']) echo 'checked="checked"'?>> Contested-->

<!--<input type="checkbox" name="q52outcome" value="Outcome" <?php if ($result['q52outcome']) echo 'checked="checked"'?>> Outcome<br>-->
