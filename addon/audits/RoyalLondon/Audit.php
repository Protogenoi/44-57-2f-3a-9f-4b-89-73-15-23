...
<?php if (isset($RL_OD1) && $RL_OD1=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckODT1();" value="1" id="yesCheckODT1" required>Yes
<input type="radio" name="OD1"
...
<input type="radio" name="OD2" <?php if (isset($RL_OD2) && $RL_OD2=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckODT2();" value="1" id="yesCheckODT2" required>Yes
...
<input type="radio" name="OD3" <?php if (isset($RL_OD3) && $RL_OD3=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckODT3();" value="1" id="yesCheckODT3" required>Yes
...
value="1" id="yesCheckODT4" required>Yes
<input type="radio" name="OD4"
...
value="1" id="yesCheckODT5" required>Yes
<input type="radio" name="OD5"
...
<input type="radio" name="CI1" <?php if (isset($RL_CI1) && $RL_CI1=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckCIT1();" value="1" id="yesCheckCIT1" required>Yes
...
<input type="radio" name="CI2" onclick="javascript:yesnoCheck();" <?php if (isset($RL_CI2) && $RL_CI2=="1") { echo "checked"; } ?> value="1" id="yesCheck" required>Yes 
...
<?php if (isset($RL_CI3) && $RL_CI3=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckCIT3();" value="1" id="yesCheckCIT3" required>Yes <input type="radio" name="CI3"
...
<input type="radio" name="CI4" <?php if (isset($RL_CI4) && $RL_CI4=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckCIT4();" value="1" id="yesCheckCIT4" required>Yes
...
<input type="radio" name="CI5" <?php if (isset($RL_CI5) && $RL_CI5=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckCIT5();" value="1" id="yesCheckCIT5" required>Yes
...
<input type="radio" name="CI6" <?php if (isset($RL_CI6) && $RL_CI6=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckCIT6();" value="1" id="yesCheckCIT6" required>Yes
...
<input type="radio" name="CI7" <?php if (isset($RL_CI7) && $RL_CI7=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckCIT7();" value="1" id="yesCheckCIT7" required>Yes
...
<input type="radio" name="CI8" <?php if (isset($RL_CI8) && $RL_CI8=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckCIT8();" value="1" id="yesCheckCIT8" required>Yes
...
<input type="radio" name="IC1" <?php if (isset($RL_IC1) && $RL_IC1=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckICT1();" value="1" id="yesCheckICT1" required>Yes
...
<input type="radio" name="IC3" <?php if (isset($RL_IC3) && $RL_IC3=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckICT3();" value="1" id="yesCheckICT3" required>Yes
...
<select class="form-control" name="IC4" onclick="javascript:yesnoCheckICT4();" required>
...
<input type="radio" name="IC5" <?php if (isset($RL_IC5) && $RL_IC5=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckICT5();" value="1" id="yesCheckICT5" required>Yes
...
<input type="radio" name="CD2" <?php if (isset($RL_CD2) && $RL_CD2=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckCDT2();" value="1" id="yesCheckCDT2" required>Yes
...
<input type="radio" name="CD3" <?php if (isset($RL_CD3) && $RL_CD3=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckCDT3();" value="1" id="yesCheckCDT3" required>Yes
...
<input type="radio" name="CD4" <?php if(isset($RL_CD4) && $RL_CD4=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckCDT4();" value="1" id="yesCheckCDT4" required>Yes
...
<input type="radio" name="CD5" <?php if(isset($RL_CD5) && $RL_CD5=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckCDT5();" value="1" id="yesCheckCDT5" required>Yes
...
<input type="radio" name="DO1" <?php if (isset($RL_DO1) && $RL_DO1=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckDOT1();" value="1" id="yesCheckDOT1" required>Yes
...
<input type="radio" name="DO2" <?php if (isset($RL_DO2) && $RL_DO2=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckDOT2();" value="1" id="yesCheckDOT2" required>Yes
...
<input type="radio" name="DO3" <?php if (isset($RL_DO3) && $RL_DO3=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckDOT3();" value="1" id="yesCheckDOT3" required>Yes
...
<input type="radio" name="DO4" <?php if (isset($RL_DO4) && $RL_DO4=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckDOT4();" value="1" id="yesCheckDOT4" required>Yes
...
<input type="radio" name="DO5" <?php if (isset($RL_DO5) && $RL_DO5=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckDOT5();" value="1" id="yesCheckDOT5" required>Yes
...
<input type="radio" name="DO6" <?php if (isset($RL_DO6) && $RL_DO6=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckDOT6();" value="1" id="yesCheckDOT6" required>Yes
...
<input type="radio" name="DO7" <?php if (isset($RL_DO7) && $RL_DO7=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckDOT7();" value="1" id="yesCheckDOT7" required>Yes
...
<input type="radio" name="DO8" <?php if (isset($RL_DO8) && $RL_DO8=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckDOT8();" value="1" id="yesCheckDOT8" required>Yes
...
<input type="radio" name="LS1" <?php if (isset($RL_LS1) && $RL_LS1=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckLST1();" value="1" id="yesCheckLST1" required>Yes
...
<input type="radio" name="LS2" <?php if (isset($RL_LS2) && $RL_LS2=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckLST2();" value="1" id="yesCheckLST2" required>Yes
...
<input type="radio" name="LS3" <?php if (isset($RL_LS3) && $RL_LS3=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckLST3();" value="1" id="yesCheckLST3" required>Yes
...
<input type="radio" name="LS4" <?php if (isset($RL_LS4) && $RL_LS4=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckLST4();" value="1" id="yesCheckLST4" required>Yes
...
<input type="radio" name="LS5" <?php if (isset($RL_LS5) && $RL_LS5=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckLST5();" value="1" id="yesCheckLST5" required>Yes
...
<input type="radio" name="LS6" <?php if (isset($RL_LS6) && $RL_LS6=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckLST6();" value="1" id="yesCheckLST6" required>Yes
...
<input type="radio" name="LS7" <?php if (isset($RL_LS7) && $RL_LS7=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckLST7();" value="1" id="yesCheckLST7" required>Yes
...
<input type="radio" name="OT1" <?php if (isset($RL_OT1) && $RL_OT1=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckOTT1();" value="1" id="yesCheckOTT1" required>Yes
...
<input type="radio" name="OT2" <?php if (isset($RL_OT2) && $RL_OT2=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckOTT2();" value="1" id="yesCheckOTT2" required>Yes
...
<input type="radio" name="OT3" <?php if (isset($RL_OT3) && $RL_OT3=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckOTT3();" value="1" id="yesCheckOTT3" required>Yes
...
<input type="radio" name="HQ1" <?php if (isset($RL_QE_HQ1) && $RL_QE_HQ1=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckHQT1();" value="1" id="yesCheckHQT1" required>Yes
...
<input type="radio" name="HQ2" <?php if (isset($RL_QE_HQ2) && $RL_QE_HQ2=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckHQT2();" value="1" id="yesCheckHQT2" required>Yes
...
<input type="radio" name="HQ3" <?php if (isset($RL_QE_HQ3) && $RL_QE_HQ3=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckHQT3();" value="1" id="yesCheckHQT3" required>Yes
...
<input type="radio" name="HQ4" <?php if (isset($RL_QE_HQ4) && $RL_QE_HQ4=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckHQT4();" value="1" id="yesCheckHQT4" required>Yes
...
<input type="radio" name="HQ5" <?php if (isset($RL_QE_HQ5) && $RL_QE_HQ5=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckHQT5();" value="1" id="yesCheckHQT5" required>Yes
...
<input type="radio" name="HQ6" <?php if (isset($RL_QE_HQ6) && $RL_QE_HQ6=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckHQT6();" value="1" id="yesCheckHQT6" required>Yes
...
<input type="radio" name="E1" <?php if (isset($RL_QE_E1) && $RL_QE_E1=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckET1();" value="1" id="yesCheckET1" required>Yes
...
<input type="radio" name="E2" <?php if (isset($RL_QE_E2) && $RL_QE_E2=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckET2();" value="1" id="yesCheckET2" required>Yes
...
<input type="radio" name="E3" <?php if (isset($RL_QE_E3) && $RL_QE_E3=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckET3();" value="1" id="yesCheckET3" required>Yes
...
<input type="radio" name="E4" <?php if (isset($RL_QE_E4) && $RL_QE_E4=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckET4();" value="1" id="yesCheckET4" required>Yes
...
<input type="radio" name="E5" <?php if (isset($RL_QE_E5) && $RL_QE_E5=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckET5();" value="1" id="yesCheckET5" required>Yes
...
<input type="radio" name="PI1" <?php if (isset($RL_QE_PI1) && $RL_QE_PI1=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckPIT1();" value="1" id="yesCheckPIT1" required>Yes
...
<input type="radio" name="PI2" <?php if (isset($RL_QE_PI2) && $RL_QE_PI2=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckPIT2();" value="1" id="yesCheckPIT2" required>Yes
...
<input type="radio" name="PI3" <?php if (isset($RL_QE_PI3) && $RL_QE_PI3=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckPIT3();" value="1" id="yesCheckPIT3" required>Yes
...
<input type="radio" name="PI4" <?php if (isset($RL_QE_PI4) && $RL_QE_PI4=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckPIT4();" value="1" id="yesCheckPIT4" required>Yes
...
<input type="radio" name="PI5" <?php if (isset($RL_QE_PI5) && $RL_QE_PI5=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckPIT5();" value="1" id="yesCheckPIT5" required>Yes
...
<input type="radio" name="CDE1" <?php if (isset($RL_QE_CDE1) && $RL_QE_CDE1=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckCDET1();" value="1" id="yesCheckCDET1" required>Yes
...
<input type="radio" name="CDE2" <?php if (isset($RL_QE_CDE2) && $RL_QE_CDE2=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckCDET2();" value="1" id="yesCheckCDET2" required>Yes
...
<input type="radio" name="CDE3" <?php if (isset($RL_QE_CDE3) && $RL_QE_CDE3=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckCDET3();" value="1" id="yesCheckCDET3" required>Yes
...
<input type="radio" name="CDE4" <?php if (isset($RL_QE_CDE4) && $RL_QE_CDE4=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckCDET4();" value="1" id="yesCheckCDET4" required>Yes
...
<input type="radio" name="CDE5"  <?php if (isset($RL_QE_CDE5) && $RL_QE_CDE5=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckCDET5();" value="1" id="yesCheckCDET5" required>Yes
...
<input type="radio" name="CDE6" <?php if (isset($RL_QE_CDE6) && $RL_QE_CDE6=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckCDET6();" value="1" id="yesCheckCDET6" required>Yes
...
<input type="radio" name="CDE7" <?php if (isset($RL_QE_CDE7) && $RL_QE_CDE7=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckCDET7();" value="1" id="yesCheckCDET7" required>Yes
...
<input type="radio" name="CDE8" <?php if (isset($RL_QE_CDE8) && $RL_QE_CDE8=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckCDET8();" value="1" id="yesCheckCDET8" required>Yes
...
<input type="radio" name="QC1" <?php if (isset($RL_QE_QC1) && $RL_QE_QC1=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckQCT1();" value="1" id="yesCheckQCT1" required>Yes
...
<input type="radio" name="QC2" <?php if (isset($RL_QE_QC2) && $RL_QE_QC2=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckQCT2();" value="1" id="yesCheckQCT2" required>Yes
...
<input type="radio" name="QC3" <?php if (isset($RL_QE_QC3) && $RL_QE_QC3=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckQCT3();" value="1" id="yesCheckQCT3" required>Yes
...
<input type="radio" name="QC4" <?php if (isset($RL_QE_QC4) && $RL_QE_QC4=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckQCT4();" value="1" id="yesCheckQCT4" required>Yes
...
<input type="radio" name="QC5" <?php if (isset($RL_QE_QC5) && $RL_QE_QC5=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckQCT5();" value="1" id="yesCheckQCT5" required>Yes
...
<p>
<label for="QC6">Q<?php $i++; echo $i; ?>. Closer provided contact details for <?php if(isset($COMPANY_ENTITY)) { echo $COMPANY_ENTITY; } ?>?</label>
<input type="radio" name="QC6" <?php if (isset($RL_QE_QC6) && $RL_QE_QC6=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckQCT6();" value="1" id="yesCheckQCT6" required>Yes
...
<input type="radio" name="QC7" <?php if (isset($RL_QE_QC7) && $RL_QE_QC7=="1") { echo "checked"; } ?> onclick="javascript:yesnoCheckQCT7();" value="1" id="yesCheckQCT7" required>Yes
...
<?php if(isset($EXECUTE)) {
    if($EXECUTE=='EDIT') { ?>
<center>
     <button type="submit" class="btn btn-success"><i class="far fa-check-circle"></i> Update Audit</button>
     </center>
<?php    }
if($EXECUTE=='EDIT') {
} } else {?>
...
<center>
    <button type="submit" class="btn btn-success"><i class="far fa-check-circle"></i> Submit Audit</button>
</center>
