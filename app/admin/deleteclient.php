...
<form id="from1" class="AddClient" method="POST" action="php/deleteclientsubmit.php?home&CID=<?php echo $CID; ?>">
<br>
...
<form id="from1" class="AddClient" method="POST" action="php/deleteclientsubmit.php?life">
<br>

<input type="hidden" name="deleteclientid" value="<?php echo $CID?>" readonly>
<button class="btn btn-danger"><span class="glyphicon glyphicon-exclamation-sign"></span> Delete Client</button>
...
<br>
    <?php } ?>
<input type="hidden" name="search" value="<?php if(isset($CID)) { echo $CID; } ?>" readonly>
