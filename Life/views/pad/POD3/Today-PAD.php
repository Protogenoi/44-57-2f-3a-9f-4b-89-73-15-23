...
<table id="pad" class="table table-hover">
    ...
    <?php $i='0'; foreach ($POD3TodayPadList as $POD3Today_Pad): ?>


        <?php
        $i++;
                $PAD_group = $POD3Today_Pad['pad_statistics_group'];
                $PAD_id = $POD3Today_Pad['pad_statistics_id'];
                $PAD_lead = $POD3Today_Pad['pad_statistics_lead'];
                $PAD_closer = $POD3Today_Pad['pad_statistics_closer'];
                $PAD_notes = $POD3Today_Pad['pad_statistics_notes'];
                $PAD_status = $POD3Today_Pad['pad_statistics_status'];
                $PAD_our_col = $POD3Today_Pad['pad_statistics_col'];
                $PAD_our_date = $POD3Today_Pad['pad_statistics_update_date'];
?>
