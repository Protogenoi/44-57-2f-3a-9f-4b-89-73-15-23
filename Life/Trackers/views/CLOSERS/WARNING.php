...
<table class="table">
    <tr>
        <th colspan="11">Tracker Stats</th>
    </tr>
    <tr>
        <th>Total</th>
        <th>No Quote</th>
    ...
    <tr>
        <td><?php if(isset($TRACKER_SUM_FORMAT)) { echo "$TRACKER_SUM_FORMAT%"; } else { echo "0%"; } ?></td>
        <td><?php if(isset($TRACKER_QNQ_FORMAT)) { echo "$TRACKER_QNQ_FORMAT%"; } else { echo "0%"; } ?></td>
        <td><?php if(isset($TRACKER_HANGUP_FORMAT)) { echo "$TRACKER_HANGUP_FORMAT%"; } else { echo "0%"; } ?></td>
        <td><?php if(isset($TRACKER_INSURER_FORMAT)) { echo "$TRACKER_INSURER_FORMAT%"; } else { echo "0%"; } ?></td>
    </tr>
</table>
         </div>
