            ...
            <fieldset>
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title"><span class="glyphicon glyphicon-headphones"></span> Aegon Closer Call Audit</h3>
                    </div>
...
<div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        <p>
                            ...
                            <input type="radio" name="PD_Q1" <?php if (isset($PD_Q1) && $PD_Q1 == "1") { echo "checked"; } ?> onclick="javascript:yesnoCheckPD_C1();" value="1" id="yesCheckPD_C1" required >Yes
                            <input type="radio" name="PD_Q1" <?php if (isset($PD_Q1) && $PD_Q1 == "0") { echo "checked"; } ?> onclick="javascript:yesnoCheckPD_C1();" value="0" id="noCheckPD_C1">No
                        </p>
...
<?php if (isset($PD_Q3) && $PD_Q3 == "0") {
    echo "checked";
                        ...
                        <div id="ifYesPD_C3" style="display:none">
                        ...
                        <script type="text/javascript">
                            ...
                            function yesnoCheckPD_C3() {
                                if (document.getElementById('yesCheckPD_C3').checked) {
                                    document.getElementById('ifYesPD_C3').style.display = 'none';
                                } else
                                    document.getElementById('ifYesPD_C3').style.display = 'block';
...
<?php if (isset($PD_Q4) && $PD_Q4 == "0") {
    echo "checked";
                        ...
                        <div id="ifYesPD_C4" style="display:none">
                        ...
                        <script type="text/javascript">
                            ...
                            function yesnoCheckPD_C4() {
                                if (document.getElementById('yesCheckPD_C4').checked) {
                                    document.getElementById('ifYesPD_C4').style.display = 'none';
                                } else
                                    document.getElementById('ifYesPD_C4').style.display = 'block';
...
<?php if (isset($PD_Q5) && $PD_Q5 == "0") {
    echo "checked";
                        ...
                        <div id="ifYesPD_C5" style="display:none">
                        ...
                        <script type="text/javascript">
                            ...
                            function yesnoCheckPD_C5() {
                                if (document.getElementById('yesCheckPD_C5').checked) {
                                    document.getElementById('ifYesPD_C5').style.display = 'none';
                                } else
                                    document.getElementById('ifYesPD_C5').style.display = 'block';
...
<?php if (isset($MD_Q1) && $MD_Q1 == "0") {
    echo "checked";
                        ...
                        <div id="ifYesMD_C1" style="display:none">
                            <textarea class="form-control"id="MD_C1" name="MD_C1" rows="1" cols="75" maxlength="1000" onkeyup="textAreaAdjust(this)"></textarea><span class="help-block"><p id="CHARS_LEFT_ID_<?php echo $QUESTION_NUMBER; ?>" class="help-block ">You have reached the limit</p></span>
                        </div>
                        <script>
                            $(document).ready(function () {
                                $('#CHARS_LEFT_ID_<?php echo $QUESTION_NUMBER; ?>').text('1000 characters left');
                        ...
                        <script type="text/javascript">
                            ...
                            function yesnoCheckMD_C1() {
                                if (document.getElementById('yesCheckMD_C1').checked) {
                                    document.getElementById('ifYesMD_C1').style.display = 'none';
                                } else
                                    document.getElementById('ifYesMD_C1').style.display = 'block';
...
<?php if (isset($MD_Q2) && $MD_Q2 == "0") {
    echo "checked";
                        ...
                        <div id="ifYesMD_C2" style="display:none">
                            <textarea class="form-control"id="MD_C2" name="MD_C2" rows="1" cols="75" maxlength="1000" onkeyup="textAreaAdjust(this)"></textarea><span class="help-block"><p id="CHARS_LEFT_ID_<?php echo $QUESTION_NUMBER; ?>" class="help-block ">You have reached the limit</p></span>
                        </div>
                        <script>
                            $(document).ready(function () {
                                $('#CHARS_LEFT_ID_<?php echo $QUESTION_NUMBER; ?>').text('1000 characters left');
                        ...
                        <script type="text/javascript">
                            ...
                            function yesnoCheckMD_C2() {
                                if (document.getElementById('yesCheckMD_C2').checked) {
                                    document.getElementById('ifYesMD_C2').style.display = 'none';
                                } else
                                    document.getElementById('ifYesMD_C2').style.display = 'block';
...
<?php if (isset($H_Q1) && $H_Q1 == "0") {
    echo "checked";
                        ...
                        <p>
                            <label for="H_Q2">Q<?php echo $QUESTION_NUMBER++; ?>. Were all the health questions - ever had, asked and recorded correclty?</label>
...
<?php if (isset($D_Q1) && $D_Q1 == "0") {
    echo "checked";
                        ...
                        <div id="ifYesD_C1" style="display:none">
                            <textarea class="form-control"id="D_C1" name="D_C1" rows="1" cols="75" maxlength="1000" onkeyup="textAreaAdjust(this)"></textarea><span class="help-block"><p id="CHARS_LEFT_ID_<?php echo $QUESTION_NUMBER; ?>" class="help-block ">You have reached the limit</p></span>
                        </div>
                        <script>
                            $(document).ready(function () {
                                $('#CHARS_LEFT_ID_<?php echo $QUESTION_NUMBER; ?>').text('1000 characters left');
                        ...
                        <script type="text/javascript">
                            ...
                            function yesnoCheckD_C1() {
                                if (document.getElementById('yesCheckD_C1').checked) {
                                    document.getElementById('ifYesD_C1').style.display = 'none';
                                } else
                                    document.getElementById('ifYesD_C1').style.display = 'block';
...
<?php if (isset($D_Q2) && $D_Q2 == "N/A") {
    echo "checked";
                        ...
                        <div id="ifYesD_C2" style="display:none">
                            <textarea class="form-control"id="D_C2" name="D_C2" rows="1" cols="75" maxlength="1000" onkeyup="textAreaAdjust(this)"></textarea><span class="help-block"><p id="CHARS_LEFT_ID_<?php echo $QUESTION_NUMBER; ?>" class="help-block ">You have reached the limit</p></span>
                        </div>
                        <script>
                            $(document).ready(function () {
                                $('#CHARS_LEFT_ID_<?php echo $QUESTION_NUMBER; ?>').text('1000 characters left');
                        ...
                        <script type="text/javascript">
                            ...
                            function yesnoCheckD_C2() {
                                if (document.getElementById('yesCheckD_C2').checked) {
                                    document.getElementById('ifYesD_C2').style.display = 'none';
                                } else
                                    document.getElementById('ifYesD_C2').style.display = 'block';
...
<?php if (isset($D_Q3) && $D_Q3 == "N/A") {
    echo "checked";
                        ...
                        <div id="ifYesD_C3" style="display:none">
                            <textarea class="form-control"id="D_C3" name="D_C3" rows="1" cols="75" maxlength="1000" onkeyup="textAreaAdjust(this)"></textarea><span class="help-block"><p id="CHARS_LEFT_ID_<?php echo $QUESTION_NUMBER; ?>" class="help-block ">You have reached the limit</p></span>
                        </div>
                        <script>
                            $(document).ready(function () {
                                $('#CHARS_LEFT_ID_<?php echo $QUESTION_NUMBER; ?>').text('1000 characters left');
                        ...
                        <script type="text/javascript">
                            ...
                            function yesnoCheckD_C3() {
                                if (document.getElementById('yesCheckD_C3').checked) {
                                    document.getElementById('ifYesD_C3').style.display = 'none';
                                } else
                                    document.getElementById('ifYesD_C3').style.display = 'block';
...
<?php if (isset($D_Q4) && $D_Q4 == "N/A") {
    echo "checked";
                        ...
                        <div id="ifYesD_C4" style="display:none">
                            <textarea class="form-control"id="D_C4" name="D_C4" rows="1" cols="75" maxlength="1000" onkeyup="textAreaAdjust(this)"></textarea><span class="help-block"><p id="CHARS_LEFT_ID_<?php echo $QUESTION_NUMBER; ?>" class="help-block ">You have reached the limit</p></span>
                        </div>
                        <script>
                            $(document).ready(function () {
                                $('#CHARS_LEFT_ID_<?php echo $QUESTION_NUMBER; ?>').text('1000 characters left');
                        ...
                        <script type="text/javascript">
                            ...
                            function yesnoCheckD_C4() {
                                if (document.getElementById('yesCheckD_C4').checked) {
                                    document.getElementById('ifYesD_C4').style.display = 'none';
                                } else
                                    document.getElementById('ifYesD_C4').style.display = 'block';
