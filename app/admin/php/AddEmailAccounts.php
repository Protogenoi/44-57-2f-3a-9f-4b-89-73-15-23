...
if ($duperaw->num_rows >= 1) {
    ...
    if($fferror=='0') {
        ...
        header('Location: ../Admindash.php?emailaccount=account1&Emails=y'); die;
    }
                                    }
}
...
if ($duperaw->num_rows >= 1) {
   ...
   header('Location: ../Admindash.php?emailaccount=account2&Emails=y'); die;
    }
                                }
}
    else {
...
if ($duperaw->num_rows >= 1) {
    ...
    $query->execute()or die(print_r($query->errorInfo(), true));
                                ...
                                if(isset($fferror)) {
    if($fferror=='0') {
    header('Location: ../Admindash.php?emailaccount=account3&Emails=y'); die;
    }
                                }
}
...
if ($duperaw->num_rows >= 1) {
    ...
    $query->execute()or die(print_r($query->errorInfo(), true));
                                ...
                                if(isset($fferror)) {
    if($fferror=='0') {
    header('Location: ../Admindash.php?emailaccount=account4&Emails=y'); die;
    }
                                }
}
    ...
    header('Location: ../Admindash.php?emailaccount=account4&Emails=y'); die;
                               ...
                               if(isset($fferror)) {
    if($fferror=='0') {
    header('Location: ../Admindash.php?emailaccount=failed&Emails=y'); die;
