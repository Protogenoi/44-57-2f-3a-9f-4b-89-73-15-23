...
$values = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT client_id,client_name,sale_date,application_number,policy_number,premium,type,insurer,commission,CommissionType,policystatus,drip,comm_term,soj,closer,lead,covera FROM ".$table." ");
