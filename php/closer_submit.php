...
<a href="/closer_form_edit.php?auditid=<?php echo $test?>">
<button type="button" class="btn btn-warning "><span class="glyphicon glyphicon-edit"></span> Edit Audit</button>
</a>
<a href="#">
