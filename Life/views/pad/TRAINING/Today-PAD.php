...
<table id="pad" class="table table-hover">
    ...
    <?php $i='0'; foreach ($TRNTodayPadList as $TRNToday_Pad): ?>


        <?php
        $i++;
                $PAD_group = $TRNToday_Pad['pad_statistics_group'];
                $PAD_id = $TRNToday_Pad['pad_statistics_id'];
                $PAD_lead = $TRNToday_Pad['pad_statistics_lead'];
                $PAD_closer = $TRNToday_Pad['pad_statistics_closer'];
                $PAD_notes = $TRNToday_Pad['pad_statistics_notes'];
                $PAD_status = $TRNToday_Pad['pad_statistics_status'];
                $PAD_our_col = $TRNToday_Pad['pad_statistics_col'];
                $PAD_our_date = $TRNToday_Pad['pad_statistics_update_date'];
?>
