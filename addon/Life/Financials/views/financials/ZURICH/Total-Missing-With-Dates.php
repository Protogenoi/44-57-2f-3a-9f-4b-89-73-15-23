    ...
    <?php foreach ($ZURICH_TotalMissingWithDatesList as $ZURICH_TotalMissingWithDatesList_Resuts): ?>


        <?php
                $MISSING_WITH_DATES_COMMISSION = $ZURICH_TotalMissingWithDatesList_Resuts['commission'];
