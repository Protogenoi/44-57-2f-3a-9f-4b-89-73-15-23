...
print("<div class=\"notice notice-danger\" role=\"alert\"><strong><i class=\"fa fa-exclamation-triangle fa-lg\"></i> Error:</strong> No changes were made!</div>");
        ...
        <ul class="nav nav-pills">
            ...
            <li><a href="ViewPensionClient.php?search=<?php echo "$search";?>"><i class='fa fa-user'></i> Back to Client</a></li>
        </ul>      
...
<div class="form-group">
  ...
  <div class="col-md-4">                     
    <textarea class="form-control" id="p2q2" name="p2q2"><?php if (isset($p2q2)) { echo "$p2q2";} ?></textarea>
  </div>
</div>
...
<?php 
            ...
            ?>
          <form class="form-horizontal" method='POST' action='php/SubmitClientSummaryReport.php?stage=5'>
              <fieldset>
