...
if ($duperaw->num_rows >= 1) {
    ...
    header('Location: ../Admindash.php?featuresupdated=ydatabase&Settings=y'); die;
...
if ($duperaw->num_rows <= 0) {
    ...
    header('Location: ../Admindash.php?featuresadded=ydatabase&Settings=y'); die;
    ...
    header('Location: ../Admindash.php?featuresadded=failed&Settings=y'); die;
