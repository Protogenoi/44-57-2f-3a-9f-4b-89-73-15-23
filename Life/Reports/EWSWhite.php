...
?>
    <div class="container">
        <ul class="nav nav-pills">
            <li class="active"><a data-toggle="pill" href="#menu2"><?php if(isset($hello_name)) { echo $hello_name; } ?> Cases to Work</a></li>
        </ul>
    </div>
   ...
   <script type="text/javascript" language="javascript" >
            ...
            return '<form action="../php/EWSNoteSubmit.php?EWS=1&REDIRECT=EWSWhite" method="POST" autocomplete="off">'+'<table cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;">'+
...
'<option value="" ></option>' +
 ...
 var me = $(this);
                    ...
                    $.ajax({ url: '../php/EWSNoteGet.php?query=EWSWhite',
                        data: {
