...
$VITALITY_COMMS_QRY = $pdo->prepare("INSERT INTO 
    ...
    $VITALITY_C_EXTRA_QRY->bindParam(':E1', $E_Q1, PDO::PARAM_INT);
    $VITALITY_C_EXTRA_QRY->bindParam(':E2', $E_Q2, PDO::PARAM_INT);
    $VITALITY_C_EXTRA_QRY->bindParam(':E3', $E_Q3, PDO::PARAM_INT);
    $VITALITY_C_EXTRA_QRY->bindParam(':E4', $E_Q4, PDO::PARAM_STR);
    $VITALITY_C_EXTRA_QRY->bindParam(':E5', $E_Q5, PDO::PARAM_STR);
    $VITALITY_C_EXTRA_QRY->bindParam(':DI1', $DI_Q1, PDO::PARAM_INT);
    $VITALITY_C_EXTRA_QRY->bindParam(':DI2', $DI_Q2, PDO::PARAM_STR);
    $VITALITY_C_EXTRA_QRY->bindParam(':PI1', $PI_Q1, PDO::PARAM_INT);
    $VITALITY_C_EXTRA_QRY->bindParam(':PI2', $PI_Q2, PDO::PARAM_INT);
    $VITALITY_C_EXTRA_QRY->bindParam(':PI3', $PI_Q3, PDO::PARAM_INT);
    $VITALITY_C_EXTRA_QRY->bindParam(':PI4', $PI_Q4, PDO::PARAM_INT);
    $VITALITY_C_EXTRA_QRY->bindParam(':PI5', $PI_Q5, PDO::PARAM_INT);
    $VITALITY_C_EXTRA_QRY->bindParam(':CD1', $CD_Q1, PDO::PARAM_INT);
    $VITALITY_C_EXTRA_QRY->bindParam(':CD2', $CD_Q2, PDO::PARAM_INT);
    $VITALITY_C_EXTRA_QRY->bindParam(':CD3', $CD_Q3, PDO::PARAM_INT);
    $VITALITY_C_EXTRA_QRY->bindParam(':CD4', $CD_Q4, PDO::PARAM_INT);
    $VITALITY_C_EXTRA_QRY->bindParam(':CD6', $CD_Q6, PDO::PARAM_INT);
    $VITALITY_C_EXTRA_QRY->bindParam(':CD7', $CD_Q7, PDO::PARAM_STR);
    $VITALITY_C_EXTRA_QRY->bindParam(':QC1', $QC_Q1, PDO::PARAM_INT);
    $VITALITY_C_EXTRA_QRY->bindParam(':QC2', $QC_Q2, PDO::PARAM_INT);
    $VITALITY_C_EXTRA_QRY->bindParam(':QC3', $QC_Q3, PDO::PARAM_INT);
    $VITALITY_C_EXTRA_QRY->bindParam(':QC4', $QC_Q4, PDO::PARAM_INT);
    $VITALITY_C_EXTRA_QRY->bindParam(':QC5', $QC_Q5, PDO::PARAM_INT);
    $VITALITY_C_EXTRA_QRY->bindParam(':QC6', $QC_Q6, PDO::PARAM_INT);
    $VITALITY_C_EXTRA_QRY->bindParam(':QC7', $QC_Q7, PDO::PARAM_INT);
    ...
    $ICN_Q5 = filter_input(INPUT_POST, 'ICN_Q5', FILTER_SANITIZE_SPECIAL_CHARS);  
     ...
     $VITALITY_QUES_QRY = $pdo->prepare("UPDATE 
                                        ...
                                        SET 
                                            ...
                                            lv_questions_od4=:OD4,
                                            lv_questions_od5=:OD5,
                                            lv_questions_ay1=:AY1,
                                            lv_questions_ay2=:AY2,
                                            lv_questions_ay3=:AY3,
                                            lv_questions_ay4=:AY4,
                                            lv_questions_ay5=:AY5,
                                            lv_questions_ay6=:AY6,
                                            lv_questions_ay7=:AY7,
                                            lv_questions_ay8=:AY8,
                                            lv_questions_p1=:P1,
                                            lv_questions_p2=:P2,
                                            lv_questions_p3=:P3,
                                            lv_questions_p4=:P4,
    ...
    $QC_Q7 = filter_input(INPUT_POST, 'QC_Q7', FILTER_SANITIZE_SPECIAL_CHARS);   
     ...
     $VITALITY_Q_EXTRA_QRY = $pdo->prepare("UPDATE
                                        ...
                                        SET
                                            ...
                                            lv_questions_extra_e4=:E4,
                                            lv_questions_extra_e5=:E5,
                                            lv_questions_extra_e6=:E6,
                                            lv_questions_extra_e7=:E7,
                                            lv_questions_extra_e8=:E8,
                                            lv_questions_extra_di1=:DI1,
                                            lv_questions_extra_di2=:DI2,
                                            lv_questions_extra_pi1=:PI1,
                                            lv_questions_extra_pi2=:PI2,
...
$VITALITY_COM_QRY = $pdo->prepare("UPDATE 
                                            lv_comments
                                        SET
                                            lv_comments_od1=:OD1, 
                                            lv_comments_od2=:OD2, 
                                        ...
                                        WHERE
                                            lv_comments_id_fk=:FK");
    $VITALITY_COM_QRY->bindParam(':FK', $AID, PDO::PARAM_INT);
    ...
    $QC_C7 = filter_input(INPUT_POST, 'QC_C7', FILTER_SANITIZE_SPECIAL_CHARS);   
     ...
     $VITALITY_C_EXTRA_QRY = $pdo->prepare("UPDATE 
                                        ...
                                        SET
                                            ...
                                            lv_comments_extra_e6=:E6,
                                            lv_comments_extra_e7=:E7,
                                            lv_comments_extra_e8=:E8,
