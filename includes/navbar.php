...
<style>
    ...
    <nav role="navigation" class="navbar navbar-default">
        ...
        <ul role='menu' class='dropdown-menu'>
            ...
            <?php if(in_array($hello_name, $Level_10_Access, true)) { ?>
            <li class="divider"></li>
            <li><a href="/addon/dialer/CloseRates.php" target="_blank">Closer Tracker Wallboard (Full)</a></li>
            <li><a href="/addon/dialer/Admin_Tracker.php" target="_blank">Closer Tracker Wallboard (Admin)</a></li>
