...
if (!in_array($_FILES['file']['type'], $csv_mimetypes)) {
    ...
    header('Location: ../DocStore.php?UPLOAD=0&Reason=FileType'); die;
 ...
 if (!file_exists(filter_input(INPUT_SERVER,'DOCUMENT_ROOT', FILTER_SANITIZE_SPECIAL_CHARS)."/app/docs/uploads/$COMPANY_ENTITY/$DOC_CAT")) {
    mkdir(filter_input(INPUT_SERVER,'DOCUMENT_ROOT', FILTER_SANITIZE_SPECIAL_CHARS)."/app/docs/uploads/$COMPANY_ENTITY/$DOC_CAT", 0777, true);
}

 $folder=filter_input(INPUT_SERVER,'DOCUMENT_ROOT', FILTER_SANITIZE_SPECIAL_CHARS)."/app/docs/uploads/$COMPANY_ENTITY/$DOC_CAT/";            
...
$UPLOAD->execute();  
    ...
    header('Location: ../DocStore.php?UPLOAD=1'); die;
 }
