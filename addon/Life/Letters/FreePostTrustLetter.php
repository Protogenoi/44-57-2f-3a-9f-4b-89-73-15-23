    ...
    function Footer()
{
    ...
    $this->Cell(0,10,'First Priority Group Limited. Registered in England and Wales FCA registered number 737871..',0,0,'C');
    $this->Ln( 5 );
    $this->Cell(0,10,'Registered office: 5 Prospect Place, Swansea SA1 1QP.',0,0,'C');
...
<br /><br><p>Once fully completed, please sign and return with the freepost envelope provided.</p>
