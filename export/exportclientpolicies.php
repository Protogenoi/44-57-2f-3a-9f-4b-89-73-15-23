...
WHERE client_policy.sale_date between '$datefrom 00:00:00' and '$dateto 24:00:00' OR (client_policy.submitted_date between '$datefrom' and '$dateto') AND client_policy.insurer !='Assura' ");
