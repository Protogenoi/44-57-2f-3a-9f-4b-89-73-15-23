...
?>
                                    <form method="POST" action="/addon/Trackers/php/Trackers.php?EXECUTE=2&TYPE=AGENT">
               <input type="hidden" value="<?php echo $TRK_EDIT_tracker_id; ?>" name="tracker_id">
                ...
                <td><input size="8" class="form-control" type="text" name="closer" id="closer" value="<?php if (isset($TRK_EDIT_closer)) {
                    ...
                    echo $TRK_EDIT_our_premium;
                                ...
                                <td><input type="text" class="form-control" name="comments" data-toggle="tooltip" title="<?php if (isset($TRK_EDIT_comments)) {
