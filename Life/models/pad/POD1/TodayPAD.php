...
class POD1TodayPadModal {
    ...
    public function POD1getTodayPad($datefrom, $TEAM) {
...
FROM
    pad_statistics
WHERE
    DATE(pad_statistics_added_date)=:datefrom AND pad_statistics_group=:team
...
class POD1TodayPadModal {
    ...
    public function POD1getTodayPad($TEAM) {
