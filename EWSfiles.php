...
<?php
    ...
    if(isset($hello_name)) { if(in_array($hello_name,array("Michael","AaronT","Matt","carys"))){ ?>
...
?>
    <div class="container">
        ...
        $EWSupload= filter_input(INPUT_GET, 'EWSupload', FILTER_SANITIZE_NUMBER_INT);
        
        if(isset($EWSupload)) {
            if($EWSupload=='1') {
                
            print("<div class='notice notice-success' role='alert'><strong><i class='fa fa-upload fa-lg'></i> Success:</strong> EWS uploaded!</div>");
        ...
        <ul class="nav nav-pills">
            ...
            <?php if($companynamere=='The Review Bureau') {
                  if(in_array($hello_name,array("Michael","AaronT","Matt","carys"))){ ?>
            ...
            ?>
            <li <?php if($companynamere=='The Review Bureau') {
                ...
                ?>><a data-toggle="pill" href="#menu1">Cases Worked</a></li>
        ...
        ?>
           ...
           <?php 
            ...
            <div class="smallcontainer"> 
                <!--
                <form class="form-inline" method="POST" action="EWSfiles.php?menu7filter=1">
                    <fieldset>
                        <legend>Filter (MASTER)</legend>
                        <div class="form-group">
                            <div class="col-md-4">
                                <input id="menu7date" name="menu7date" class="form-control" placeholder="Clawback date" type="text">
                            </div>
                        </div>
                            
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="clawcolour"></label>
                            <div class="col-md-4">
	...
	LEFT JOIN financial_statisics ON financial_statisics.policy_number=ews_data.policy_number WHERE clawback_date = :date ORDER BY ews_data.color_status");
        ...
        <div id="menu1" class="tab-pane fade <?php if(isset($hello_name)) {  if(!in_array($hello_name,array("Michael","carys","Matt"))){echo "in active";} } ?>">   
            ...
            <div class="smallcontainer">
                <form class="form-vertical" method="POST" action="EWSfiles.php?menu1filter=1">
                    <fieldset>
                        ...
                        <div class="col-xs-2">
                                ...
                                <a href="EWSfiles.php" class="btn btn-danger btn-sm"><i class="fa fa-refresh"></i> Reset</a>
                        </div>
...
<div class="col-xs-2">
    ...
    <a href="EWSfiles.php" class="btn btn-danger "><span class="glyphicon glyphicon-repeat"></span> Reset</a>
    </div>
  </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-xs-6 col-md-6">
                                    ...
                                    <form action="/upload/ewsupload.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
