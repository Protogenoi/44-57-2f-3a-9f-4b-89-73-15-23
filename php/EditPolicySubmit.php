...
header('Location: ../Life/ViewClient.php?policyadded=y&search='.$keyfield.'&dupepolicy='.$dupepol.'&origpolicy='.$policy_number); die;     
    }
}
...
header('Location: ../Life/ViewClient.php?policyedited=y&search='.$keyfield); die;
