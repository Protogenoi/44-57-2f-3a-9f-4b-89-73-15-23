                    ...
                    <fieldset>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <input required id="searchquery" name="searchquery" placeholder="Search For" value="<?php if (isset($SEARCH_searchquery)) {
                echo $SEARCH_searchquery;
        ...
        <script type="text/javascript" language="javascript" >
            ...
            $(document).ready(function () {
                var table = $('#clients').DataTable({
                    ...
                    "ajax": "/datatables/ClientSearch.php?ClientSearch=6",
                    "columns": [
                        {
