...
<p>
    <label for="CI1">Q<?php $i++; echo $i; ?>. Did the closer ask if the customer is covered by Vitality and did they record the answer correctly?</label><br>
...
<p>
    <label for="CI1">Q<?php $i++; echo $i; ?>. Did the closer ask if the customer had applied for cover with Vitality in the last 12 months?</label><br>
