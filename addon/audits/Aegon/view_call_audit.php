...
<!DOCTYPE html>
<html lang="en">
    <title>ADL | View Aegon Call Audit</title>
    <meta charset="UTF-8">
       ...
       <div class="wrapper col4">
            <table id='users'>
                <thead>
                    ...
                    <tr>
                        <td colspan=2><b>Aegon Call Audit ID: <?php echo $AUDITID ?></b></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        if ($VIT_GRADE == 'Amber') {
                            echo "<td style='background-color: #FF9900;' colspan=2><b>$VIT_GRADE | ($TOTAL/57)</b></td>";
                        } else if ($VIT_GRADE == 'Green') {
                            echo "<td style='background-color: #109618;' colspan=2><b>$VIT_GRADE | ($TOTAL/57)</b></td>";
                        } else if ($VIT_GRADE == 'Red') {
                            echo "<td style='background-color: #DC3912;' colspan=2><b>$VIT_GRADE | ($TOTAL/57)</b></td>";
                        }
                        ?>
                    </tr>
...
<p>
<label for="ICN5">Q<?php $i++; echo $i; ?>. Closer confirmed this policy will be set up with Aegon?</label><br>
...
<div class="phpcomments"><?php if(isset($DEC_C8)) { echo $DEC_C8; } ?></div>
 ...
 <p>
     <label for="QC1">Q<?php $i++; echo $i; ?>. Closer confirmed that they have set up the client on a level/decreasing/CIC term policy with Aegon with client information?</label><br>
