...
<!DOCTYPE html>
<html>
    <title>ADL | Search Compliants</title>
    <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class='notice notice-info' role='alert'><strong><i class='fa fa-edit fa-exclamation'></i> Info:</strong> Clients shown below have a complaint logged to them. 
