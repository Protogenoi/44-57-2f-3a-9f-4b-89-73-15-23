        ...
        <script type="text/javascript" language="javascript" >
            ...
            $(document).ready(function () {
                var table = $('#clients').DataTable({
                    ...
                    "ajax": "/app/JSON/ClientSearch.php?ClientSearch=1&USER=<?php echo $hello_name; ?>&TOKEN=<?php echo $TOKEN; ?>",
                    "columns": [
                        {
                        ...
                        {"data": "client_id",
                            "render": function (data, type, full, meta) {
                                return '<a href="/addon/Life/NewPolicy.php?EXECUTE=1&search=' + data + '">Add Policy</a>';
                            }}
                    ]
                });
