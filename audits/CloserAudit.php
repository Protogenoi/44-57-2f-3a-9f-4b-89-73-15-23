...
<p>
<label for="q54">Q34. If appropirate did the closer confirm the exclusions on the policy?</label>
...
<button type="button" class="btn btn-danger "><span class="glyphicon glyphicon-chevron-left"></span> Back</button>
</a>-->
<center>
