...
<table id="pad" class="table table-hover">
    ...
    <?php $i='0'; foreach ($POD2TodayPadList as $POD2Today_Pad): ?>


        <?php
        $i++;
                $PAD_group = $POD2Today_Pad['pad_statistics_group'];
                $PAD_id = $POD2Today_Pad['pad_statistics_id'];
                $PAD_lead = $POD2Today_Pad['pad_statistics_lead'];
                $PAD_closer = $POD2Today_Pad['pad_statistics_closer'];
                $PAD_notes = $POD2Today_Pad['pad_statistics_notes'];
                $PAD_status = $POD2Today_Pad['pad_statistics_status'];
                $PAD_our_col = $POD2Today_Pad['pad_statistics_col'];
                $PAD_our_date = $POD2Today_Pad['pad_statistics_update_date'];
?>
