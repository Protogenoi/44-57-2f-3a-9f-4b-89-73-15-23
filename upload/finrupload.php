...
$reggy = "%$regpol%";
/*
            mysqli_query($GLOBALS["___mysqli_ston"], "REPLACE INTO financial_statisics (comm_date, sale_date, policy_number, sales_person, trans_type, source, target, deduction, payment, processor) VALUES
                (
                    CURDATE(),
                    '".addslashes($data[0])."',
                    '".addslashes($data[1])."',
