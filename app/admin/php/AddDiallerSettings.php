...
if ($duperaw->num_rows <= 0) {
    ...
    header('Location: ../Admindash.php?vicidialaccount=database&Vicidial=y'); die;
    }
                    }
}
...
if ($duperaw->num_rows <= 0) {
        ...
        $INSERT->execute()or die(print_r($INSERT->errorInfo(), true));
                ...
                if(isset($fferror)) {
    if($fferror=='0') {
    header('Location: ../Admindash.php?vicidialaccount=telephony&Vicidial=y'); die;
    }
                }
}
...
if ($duperaw->num_rows <= 0) {
    ...
    header('Location: ../Admindash.php?connexaccount=database&Connex=y'); die;
    }
                    }
}
                ...
                if(isset($fferror)) {
    if($fferror=='0') {
    header('Location: ../Admindash.php?connexaccount=failed&Connex=y'); die;
    }
                }
}