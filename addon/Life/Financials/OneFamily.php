            ...
            <div class="container"> 
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">One Family Financial Statistics</h3>
                    </div>
...
//CALCULATE MISSING AMOUNT WITH DATES. Polices on SALE DATE RANGE BUT NOT ON RAW COMMS
    require_once(__DIR__ . '/models/financials/BEDROCK/WOL/TotalMissingWithDates.php');
    ...
    require_once(__DIR__ . '/views/financials/BEDROCK/WOL/Total-Missing-With-Dates.php');
                       //END OF CALCULATION
    
//CALCULATE AWAITING AMOUNT WITH DATES
    require_once(__DIR__ . '/models/financials/BEDROCK/WOL/TotalAwaitingWithDates.php');
    ...
    require_once(__DIR__ . '/views/financials/BEDROCK/WOL/Total-Awaiting-With-Dates.php');                            
    //END OF CALCULATION
    
//CALCULATE EXPECTED AMOUNT WITH DATES
    require_once(__DIR__ . '/models/financials/BEDROCK/WOL/TotalExpectedWithDates.php');
    ...
    require_once(__DIR__ . '/views/financials/BEDROCK/WOL/Total-Expected-With-Dates.php');  
...
WHERE
    ...
    AND
        financials_provider ='One Family'");
                ...
                <table class="table table-hover">
                    ...
                    if ($query->rowCount() > 0) {
                        ...
                        while ($row = $query->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            echo "<td><a href='php/Recheck.php?EXECUTE=1&INSURER=WOL&BRID=$BRID&AMOUNT=$paytype&POLICY=$policy' class='btn btn-success btn-sm'><i class='fa fa-check-circle-o'></i></a></td>";
