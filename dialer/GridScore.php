...
<body class="backcolour">
    ...
    <div class="container">
              ...
              <center>
      <?php 
      $Today_DATES = date("l jS \of F");
      $Today_TIME =date("H:i:s");
      echo "<h3 style='color:white;'>$Today_DATES $Today_TIME</h3>";
      ?>
      </center>
...
LEFT JOIN vicidial_auto_calls on vicidial_live_agents.lead_id = vicidial_auto_calls.lead_id
WHERE vicidial_live_agents.campaign_id IN ('10','13','14')
