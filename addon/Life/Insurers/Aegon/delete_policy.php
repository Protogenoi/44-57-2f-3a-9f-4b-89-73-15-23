...
-->
        <html lang="en">
            <title>ADL | Delete Aegon Policy</title>
            <meta charset="UTF-8">
            ...
            <form action="" class="form-horizontal" role="form">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div id="panel161" class="panel panel-danger" data-role="panel" style="display: block;">
        <div class="panel-heading">Delete <?php if(isset($data2['adl_policy_policy_holder'])) { echo $data2['adl_policy_policy_holder'];  } ?> Aegon Policy</div>
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="form-group" style="display: block;">
                    ...
                    <div class="controls col-sm-9">
                        <input readonly value="<?php if(isset($data2['aegon_policy_type'])) { echo $data2['aegon_policy_type'];  } ?>" type="text" class="form-control k-textbox" data-role="text"  >
                    </div>
                </div>        
            ...
            <div class="col-md-4">
                 ...
                 <div class="form-group" style="display: block;">
                    ...
                    <div class="controls col-sm-9">
                        <input readonly value="<?php if(isset($data2['aegon_policy_premium'])) { echo $data2['aegon_policy_premium'];  } ?>" type="text" class="form-control k-textbox" data-role="text"  >
                    </div>
                </div>                
                 ...
                 <div class="form-group" style="display: block;">
                    ...
                    <div class="controls col-sm-9">
                        <input readonly value="<?php if(isset($data2['aegon_policy_comms_type'])) { echo $data2['aegon_policy_comms_type'];  } ?>" type="text" class="form-control k-textbox" data-role="text"  >
                    </div>
                </div>                               
                 ...
                 <div class="form-group" style="display: block;">
                    ...
                    <div class="controls col-sm-9">
                        <input readonly value="<?php if(isset($data2['aegon_policy_comms'])) { echo $data2['aegon_policy_comms'];  } ?>" type="text" class="form-control k-textbox" data-role="text"  >
                    </div>
                </div>  
                 ...
                 <div class="form-group" style="display: block;">
                    ...
                    <div class="controls col-sm-9">
                        <input readonly value="<?php if(isset($data2['aegon_policy_non_indem_comms'])) { echo $data2['aegon_policy_non_indem_comms'];  } ?>" type="text" class="form-control k-textbox" data-role="text"  >
                    </div>
                </div>                 
                 ...
                 <div class="form-group" style="display: block;">
                    ...
                    <div class="controls col-sm-9">
                        <input readonly value="<?php if(isset($data2['aegon_policy_cover_amount'])) { echo $data2['aegon_policy_cover_amount'];  } ?>" type="text" class="form-control k-textbox" data-role="text"  >
                    </div>
                </div> 
                 ...
                 <div class="form-group" style="display: block;">
                    ...
                    <div class="controls col-sm-9">
                        <input readonly value="<?php if(isset($data2['aegon_policy_policy_term'])) { echo $data2['aegon_policy_policy_term'];  } ?>" type="text" class="form-control k-textbox" data-role="text"  >
                    </div>
                </div>   
                 ...
                 <div class="form-group" style="display: block;">
                    ...
                    <div class="controls col-sm-9">
                        <input readonly value="<?php if(isset($data2['aegon_policy_cb_term'])) { echo $data2['aegon_policy_cb_term'];  } ?>" type="text" class="form-control k-textbox" data-role="text"  >
                    </div>
                </div>                 
                 ...
                 <div class="form-group" style="display: block;">
                    ...
                    <div class="controls col-sm-9">
                        <input readonly value="<?php if(isset($data2['aegon_policy_drip'])) { echo $data2['aegon_policy_drip'];  } ?>" type="text" class="form-control k-textbox" data-role="text"  >
                    </div>
                </div>   
 ...
 <div class="form-group">
     <div class="col-md-10">
         ...
         <form action="/addon/Life/php/delete_policy.php?EXECUTE=1&PID=<?php echo $PID; ?>&CID=<?php echo $CID; ?>&HOLDER=<?php echo $data2['adl_policy_policy_holder']; ?>&POL=<?php echo $data2['adl_policy_ref']; ?>" name="DELETE_FORM" id="DELETE_FORM" method="POST">
         <button type="submit" class="btn btn-danger"><i class="fa fa-trash"></i> Delete Policy</button>
         </form>
         </center>
     </div>
 </div>                
