...
if(isset($EXECUTE)) {
    if($EXECUTE == 1 ) {
        ...
        $query = $pdo->prepare("SELECT
            adl_ews_master_ref, 
            adl_ews_master_modified_ref,
            adl_ews_master_client_name, 
            adl_ews_master_orig_status, 
            adl_ews_master_status,
            adl_ews_master_colour, 
            adl_ews_master_insurer, 
            adl_ews_master_date_added,
            adl_ews_master_updated_date,
            adl_ews_master_client_id
        FROM
            adl_ews_master");
