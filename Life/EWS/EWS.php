    ...
    //END OF CALCULATION       
                        ...
                        <table  class="table table-hover">
                            <thead>
                                ...
                                <th>CFO <i class="fa fa-question-circle-o" style="color:skyblue" title="Total policies classed as CFO for EWS uploaded on the <?php echo "$EWS_DATE"; ?>."</i> <a href="../Export/EWS.php?EXECUTE=RAW&WARNING=CFO&EWS_DATE=<?php echo $EWS_DATE; ?>&USER=<?php echo $hello_name; ?>&TOKEN=<?php echo $TOKEN; ?>"><i class="fa fa-download" style="color:orange" title="Download"></i></a></th> 
                                <th>Lapsed <i class="fa fa-question-circle-o" style="color:skyblue" title="Total policies classed as Lapsed for EWS uploaded on the <?php echo "$EWS_DATE"; ?>." ></i> <a href="../Export/EWS.php?EXECUTE=RAW&WARNING=LAPSED&EWS_DATE=<?php echo $EWS_DATE; ?>&USER=<?php echo $hello_name; ?>&TOKEN=<?php echo $TOKEN; ?>"><i class="fa fa-download" style="color:orange" title="Download"></i></a></th>
                                ...
                                <th>Cancelled <i class="fa fa-question-circle-o" style="color:skyblue" title="Total policies classed as CFO and Lapsed for EWS uploaded on the <?php echo "$EWS_DATE"; ?>."</i> <a href="../Export/EWS.php?EXECUTE=RAW_CANCELLED&EWS_DATE=<?php echo $EWS_DATE; ?>&USER=<?php echo $hello_name; ?>&TOKEN=<?php echo $TOKEN; ?>"><i class="fa fa-download" style="color:orange" title="Download"></i></a></th>
                                <th>Uploaded</th>
                            </tr>
                            </thead>
                            ...
                            <thead>
                                ...
                                <tr>
                                    <th colspan="8"><?php echo "Updated RAW Statistics for $EWS_DATE";?> 
                                        <i class="fa fa-question-circle-o" style="color:skyblue" title="Download Updated RAW EWS <?php echo "$EWS_DATE"; ?>."></i> <a href="../Export/EWS.php?EXECUTE=UPDATED_EWS&EWS_DATE=<?php echo $EWS_DATE; ?>&USER=<?php echo $hello_name; ?>&TOKEN=<?php echo $TOKEN; ?>"><i class="fa fa-download" style="color:orange" title="Download"></i> Updated</a>
                                    </th>
                                </tr>
    ...
    ?>
                        <table  class="table table-hover">
                            <thead>
                                ...
                                <th>RE-INSTATED <i class="fa fa-question-circle-o" style="color:skyblue" title="Total policies classed as RE-INSTATED within the date range of <?php echo "$datefrom - $dateto"; ?>."</i> <a href="../Export/EWS.php?EXECUTE=ADL&WARNING=RE-INSTATED&&datefrom=<?php echo $datefrom; ?>&dateto=<?php echo $dateto; ?>&USER=<?php echo $hello_name; ?>&TOKEN=<?php echo $TOKEN; ?>"><i class="fa fa-download" style="color:orange" title="Download"></i></a></th> 
                                <th>WILL CANCEL <i class="fa fa-question-circle-o" style="color:skyblue" title="Total policies classed as WILL CANCEL within the date range of <?php echo "$datefrom - $dateto"; ?>." ></i> <a href="../Export/EWS.php?EXECUTE=ADL&WARNING=WILL CANCEL&datefrom=<?php echo $datefrom; ?>&dateto=<?php echo $dateto; ?>&USER=<?php echo $hello_name; ?>&TOKEN=<?php echo $TOKEN; ?>"><i class="fa fa-download" style="color:orange" title="Download"></i></a></th>
                                <th>WILL REDRAW <i class="fa fa-question-circle-o" style="color:skyblue" title="Total policies classed as WILL REDRAW within the date range of <?php echo "$datefrom - $dateto"; ?>."></i> <a href="../Export/EWS.php?EXECUTE=ADL&WARNING=WILL REDRAW&datefrom=<?php echo $datefrom; ?>&dateto=<?php echo $dateto; ?>&USER=<?php echo $hello_name; ?>&TOKEN=<?php echo $TOKEN; ?>"><i class="fa fa-download" style="color:orange" title="Download"></i></a></th>
                                <th>REDRAWN <i class="fa fa-question-circle-o" style="color:skyblue" title="Total policies classed as REDRAWN within the date range of <?php echo "$datefrom - $dateto"; ?>."</i> <a href="../Export/EWS.php?EXECUTE=ADL&WARNING=REDRAWN&datefrom=<?php echo $datefrom; ?>&dateto=<?php echo $dateto; ?>&USER=<?php echo $hello_name; ?>&TOKEN=<?php echo $TOKEN; ?>"><i class="fa fa-download" style="color:orange" title="Download"></i></a></th>
                                <th>Cancelled <i class="fa fa-question-circle-o" style="color:skyblue" title="Total policies classed as CANCELLED within the date range of <?php echo "$datefrom - $dateto"; ?>."</i> <a href="../Export/EWS.php?EXECUTE=ADL&WARNING=CANCELLED&datefrom=<?php echo $datefrom; ?>&dateto=<?php echo $dateto; ?>&USER=<?php echo $hello_name; ?>&TOKEN=<?php echo $TOKEN; ?>"><i class="fa fa-download" style="color:orange" title="Download"></i></a></th>
                            </tr>
                            </thead>
