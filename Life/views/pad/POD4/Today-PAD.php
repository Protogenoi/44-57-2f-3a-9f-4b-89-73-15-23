...
<table id="pad" class="table table-hover">
    ...
    <?php $i='0'; foreach ($POD4TodayPadList as $POD4Today_Pad): ?>


        <?php
        $i++;
                $PAD_group = $POD4Today_Pad['pad_statistics_group'];
                $PAD_id = $POD4Today_Pad['pad_statistics_id'];
                $PAD_lead = $POD4Today_Pad['pad_statistics_lead'];
                $PAD_closer = $POD4Today_Pad['pad_statistics_closer'];
                $PAD_notes = $POD4Today_Pad['pad_statistics_notes'];
                $PAD_status = $POD4Today_Pad['pad_statistics_status'];
                $PAD_our_col = $POD4Today_Pad['pad_statistics_col'];
                $PAD_our_date = $POD4Today_Pad['pad_statistics_update_date'];
?>
