...
if(isset($ClientSearch)) {
    ...
    if($ClientSearch=='4') { 
        ...
        $query = $pdo->prepare('SELECT CONCAT(firstname, " ", lastname) AS Name, CONCAT (firstname2, " ", lastname2) AS Name2, submitted_date, tel, tel2, post_code, client_id FROM pba_client_details');
