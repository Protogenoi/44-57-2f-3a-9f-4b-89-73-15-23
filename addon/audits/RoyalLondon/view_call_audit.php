...
<!DOCTYPE html>
<html lang="en">
    <title>ADL | View Royal London Call Audit</title>
    <meta charset="UTF-8">
            ...
            <table id='users'>
                <thead>
                    ...
                    <tr>
                        ...
                        if ($VIT_GRADE == 'Amber') {
                            echo "<td style='background-color: #FF9900;' colspan=2><b>$VIT_GRADE | (60/$TOTAL)</b></td>";
...
<p>
<label for="ICN4">Q<?php $i++; echo $i; ?>. Did the closer confirm that this policy would be set up with Royal London?</label><br>
...
<p>
<label for="E6">Q<?php $i++; echo $i; ?>. Did the closer ask if the customer was a UK resident?</label><br>
...
<p>
<label for="E7">Q<?php $i++; echo $i; ?>. Did the closer ask the customer occupation?</label><br>
...
<p>
<label for="E8">Q<?php $i++; echo $i; ?>. Did the closer confirm the customers address?</label><br>
...
<p>
    <label for="CI1">Q<?php $i++; echo $i; ?>. Did the closer ask if the customer is covered by Royal London and did they record the answer correctly?</label><br>
...
<p>
    <label for="CI1">Q<?php $i++; echo $i; ?>. Did the closer ask if the customer has ever had an application for life insurance that was deferred or declined?</label><br>
...
<p>
    <label for="CI1">Q<?php $i++; echo $i; ?>. Did the closer ask if the customer had exiting life cover exceeding £1m or £500k critical illness?</label><br>
...
<p>
    <label for="L1">Q<?php $i++; echo $i; ?>. Did the closer ask the customers 'Height and Weight' and did they record the answers correctly?</label><br>
...
<p>
    <label for="L2">Q<?php $i++; echo $i; ?>. Did the closer ask if the customer 'Trouser/Dress size' and did they record the answers correctly?</label><br>
...
<p>
    <label for="L3">Q<?php $i++; echo $i; ?>. Did the closer ask the customers 'Smoking status' and did the closer record the answer correctly?</label><br>
...
<p>
    <label for="L4">Q<?php $i++; echo $i; ?>. Did the closer ask the customer what the customer had smoked and how many per day in the last 12 months?</label><br>
...
<p>
    <label for="L5">Q<?php $i++; echo $i; ?>. Did the closer ask the customer how many units of alcohol does the customer drink per week and did they record the answers correctly?</label><br>
...
<p>
    <label for="L6">Q<?php $i++; echo $i; ?>. Did the closer ask if the customer has been advised to reduce alcohol consumption?</label><br>
...
<p>
    <label for="L7">Q<?php $i++; echo $i; ?>. Did the closer ask the customer if they have taken any drugs in the last 10 years?</label><br>
...
<p>
    <label for="L8">Q<?php $i++; echo $i; ?>. Did the closer ask if the customer intends to take part in any hazardous activities?</label><br>
...
<p>
    <label for="O1">Q<?php $i++; echo $i; ?>. Did the closer ask if the customers current job involves manual work or driving?</label><br>
...
<p>
    <label for="O2">Q<?php $i++; echo $i; ?>. Did the closer ask if the customer is involved in any of the hazardous activities listed?</label><br>
...
<p>
    <label for="O3">Q<?php $i++; echo $i; ?>. Did the closer ask if the customer has lived, worked or travelled to the listed areas during the last two years?</label><br>
...
<p>
    <label for="H3">Q<?php $i++; echo $i; ?>. Did the closer ask all the "any condition in the last 3 years" health questions and did the closer record the answers correctly?</label><br>
...
<p>
    <label for="FAM1">Q<?php $i++; echo $i; ?>. Did the closer ask the customer's family history and did they record the answers correctly?</label><br>
...
<p>
<label for="CDE6">Q<?php $i++; echo $i; ?>. Closer confirmed an approximate direct debit date and informed the customer it is not an exact date, but Royal London will write to them with a more specific date?</label><br>
