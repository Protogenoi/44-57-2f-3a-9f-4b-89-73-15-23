...
if ($duperaw->num_rows >= 1) {
    ...
    $query->execute()or die(print_r($query->errorInfo(), true));
                  ...
                  $updatestage = $pdo->prepare("UPDATE pension_stages set complete ='Yes' WHERE client_id =:clientid AND task='Summary Sheet'");
              $updatestage->bindParam(':clientid', $search, PDO::PARAM_INT);
              $updatestage->execute()or die(print_r($updatestage->errorInfo(), true));
