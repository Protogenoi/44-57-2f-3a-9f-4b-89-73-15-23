...
class combat_cal {
    ...
    function weapons($HITS,$UNIT,$TARGET_UNIT,$UNIT_WEAPON,$RAPID_FIRE,$FACTION,$ENEMY_FACTION) {
    ...
    if($UNIT_WEAPON=='Krak grenade') {
        ...
        $WEAPON_RANGE=6;
              ...
              $combat_cal->roll(6,$HITS,$UNIT,$TARGET_UNIT,$UNIT_WEAPON,$RAPID_FIRE,$FACTION,$ENEMY_FACTION,$U_BS);    
