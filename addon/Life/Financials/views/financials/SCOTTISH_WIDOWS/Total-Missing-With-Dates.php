    ...
    <?php foreach ($SCOTTISH_WIDOWS_TotalMissingWithDatesList as $SCOTTISH_WIDOWS_TotalMissingWithDatesList_Resuts): ?>


        <?php
                $MISSING_WITH_DATES_COMMISSION = $SCOTTISH_WIDOWS_TotalMissingWithDatesList_Resuts['commission'];
