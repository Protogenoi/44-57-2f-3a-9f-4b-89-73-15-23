...
if (isset($INSURER)) {
    if ($INSURER == 'RoyalLondon') {
        header('Location: RoyalLondon.php?INSURER=' . $INSURER);
        die;
    }
    if ($INSURER == 'Aviva') {
        header('Location: Aviva.php?INSURER=' . $INSURER);
        die;
    }
    if ($INSURER == 'WOL') {
        header('Location: OneFamily.php?INSURER=' . $INSURER);
        die;
    }
    if ($INSURER == 'Vitality') {
        header('Location: Vitality.php?INSURER=' . $INSURER);
        die;
    }
}
