...
$UPLOAD = filter_input(INPUT_GET, 'UPLOAD', FILTER_SANITIZE_FULL_SPECIAL_CHARS);

if(isset($UPLOAD) && $UPLOAD =='MAX') { ?>

    <div class="notice notice-danger" role="alert"><strong><i class="fa fa-cloud-upload"></i> UPLOAD FAILED:</strong> File size to big!</div> 
