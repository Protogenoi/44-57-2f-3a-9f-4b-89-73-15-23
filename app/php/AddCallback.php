        ...
        if(isset($EXECUTE)){
            ...
            $CBK_ID= filter_input(INPUT_GET, 'CBK_ID', FILTER_SANITIZE_NUMBER_INT);
                                                ...
                                                if ($EXECUTE =='1') {
                                                    ...
                                                    header('Location: /app/calendar/calendar.php?callback=complete&CALL_ID'.$CBK_ID); die;
                                                ...
                                                if ($EXECUTE =='n') {
                                                    ...
                                                    header('Location: /Client.php?Addcallback=complete&CALL_ID'.$CBK_ID.'&search='.$search); die;
                                                ...
                                                if ($EXECUTE =='nV') {
                                                    ...
                                                    header('Location: /Client.php?Addcallback=incomplete&search='.$search); die;
   ...
   if(isset($callsub)){
       ...
       if(isset($ffcalendar)) { 
           ...
           if ($database->rowCount()>0) {
             ...
             header('Location: ../Client.php?CallbackSet=1&search='.$search.'&CallbackTime='.$getcallback_time.'&CallbackDate='.$getcallback_date); die;
                              
           }
           
           else {
               
               header('Location: ../Client.php?CallbackSet=0&search='.$search); die;
