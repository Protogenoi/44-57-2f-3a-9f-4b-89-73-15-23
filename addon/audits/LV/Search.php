...
"fnRowCallback": function(  nRow, aData, iDisplayIndex, iDisplayIndexFull ) {
   if ( aData["lv_audit_grade"] == "Red" )  {
          $(nRow).addClass( 'Red' );
}
   else  if ( aData["lv_audit_grade"] == "Amber" )  {
          $(nRow).addClass( 'Amber' );
    }
   else if ( aData["lv_audit_grade"] == "Green" )  {
          $(nRow).addClass( 'Green' );
    }
   else if ( aData["lv_audit_grade"] == "Saved" )  {
...
"aLengthMenu": [[5, 10, 25, 50, 100, 125, 150, 200, 500], [5, 10, 25, 50, 100, 125, 150, 200, 500]],
        ...
        "columns": [
            ...
            { "data": "lv_audit_added_date" },
            { "data": "lv_audit_id"},
            { "data": "lv_audit_ref"},
            { "data": "lv_audit_closer" },
            { "data": "lv_audit_auditor" },
            { "data": "lv_audit_grade" },
  { "data": "lv_audit_id",
